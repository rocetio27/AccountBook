...
var inputVars = {
	db_id: Observable(temp_initial_value.value.db_id),
...
function Submit() {
	if(inputVars.pmType.value=="+"){
		...
		TempDB.InitialValueSave(inputVars.db_id.value, inputVars.account_id.value, inputVars.amount.value, inputVars.dateTime.value, inputVars.usage.value, inputVars.payType.value, inputVars.pmType.value);
