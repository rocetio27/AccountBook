...
namespace g{struct AccountBook_FuseReactiveEach_Offset_Property;}
...
struct AccountBook_FuseReactiveEach_Offset_Property : ::g::Uno::UX::Property1
{
    uWeak< ::g::Fuse::Reactive::Each*> _obj;

    void ctor_3(::g::Fuse::Reactive::Each* obj, ::g::Uno::UX::Selector name);
    static AccountBook_FuseReactiveEach_Offset_Property* New1(::g::Fuse::Reactive::Each* obj, ::g::Uno::UX::Selector name);
};
// }
