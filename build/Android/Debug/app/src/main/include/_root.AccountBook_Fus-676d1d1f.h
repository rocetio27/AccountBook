...
namespace g{struct AccountBook_FuseElementsElement_Margin_Property;}
...
struct AccountBook_FuseElementsElement_Margin_Property : ::g::Uno::UX::Property1
{
    uWeak< ::g::Fuse::Elements::Element*> _obj;

    void ctor_3(::g::Fuse::Elements::Element* obj, ::g::Uno::UX::Selector name);
    static AccountBook_FuseElementsElement_Margin_Property* New1(::g::Fuse::Elements::Element* obj, ::g::Uno::UX::Selector name);
};
// }
