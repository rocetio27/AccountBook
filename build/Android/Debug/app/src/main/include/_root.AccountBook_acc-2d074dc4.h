...
namespace g{struct AccountBook_accessor_myButton_text;}
...
struct AccountBook_accessor_myButton_text : ::g::Uno::UX::PropertyAccessor
{
    static uSStrong< ::g::Uno::UX::PropertyAccessor*> Singleton_;
    static uSStrong< ::g::Uno::UX::PropertyAccessor*>& Singleton() { return AccountBook_accessor_myButton_text_typeof()->Init(), Singleton_; }
    static ::g::Uno::UX::Selector _name_;
    static ::g::Uno::UX::Selector& _name() { return AccountBook_accessor_myButton_text_typeof()->Init(), _name_; }

    void ctor_1();
    static AccountBook_accessor_myButton_text* New1();
};
// }
