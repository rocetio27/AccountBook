...
namespace g{struct BudgetPage__Template;}
...
struct BudgetPage__Template : ::g::Uno::UX::Template
{
    ...
    static ::g::Uno::UX::Selector& __selector0() { return BudgetPage__Template_typeof()->Init(), __selector0_; }

    void ctor_1(::g::BudgetPage* parent, ::g::BudgetPage* parentInstance);
    static BudgetPage__Template* New2(::g::BudgetPage* parent, ::g::BudgetPage* parentInstance);
};
// }
