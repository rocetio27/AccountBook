...
namespace g{struct BudgetPage__Template3;}
...
struct BudgetPage__Template3 : ::g::Uno::UX::Template
{
    ...
    static ::g::Uno::UX::Selector& __selector0() { return BudgetPage__Template3_typeof()->Init(), __selector0_; }

    void ctor_1(::g::BudgetPage* parent, ::g::BudgetPage* parentInstance);
    static BudgetPage__Template3* New2(::g::BudgetPage* parent, ::g::BudgetPage* parentInstance);
};
// }
