...
namespace g{struct ListPage__Template;}
...
struct ListPage__Template : ::g::Uno::UX::Template
{
    uWeak< ::g::ListPage*> __parent1;
    uWeak< ::g::ListPage*> __parentInstance1;

    void ctor_1(::g::ListPage* parent, ::g::ListPage* parentInstance);
    static ListPage__Template* New2(::g::ListPage* parent, ::g::ListPage* parentInstance);
};
// }
