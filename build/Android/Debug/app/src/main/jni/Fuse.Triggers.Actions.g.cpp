...
void Show__Perform_fn(Show* __this, ::g::Fuse::Node* target)
{
    ...
    if (t != NULL)
        ...
        ::g::Fuse::Diagnostics::UserError(::STRINGS[12/*"Cannot find...*/], __this, ::STRINGS[1/*"C:\\Users\\...*/], 38, ::STRINGS[2/*"Perform"*/], NULL);
}
// }
...
void TimelineAction__Perform_fn(TimelineAction* __this, ::g::Fuse::Node* target)
{
    ...
    if (t == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[13/*"`TimelineAc...*/], __this, ::STRINGS[14/*"C:\\Users\\...*/], 48, ::STRINGS[2/*"Perform"*/], NULL);
        return;
    }
...
void Toggle__Perform_fn(Toggle* __this, ::g::Fuse::Node* target)
{
    ...
    if (t == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[15/*"Could not f...*/], __this, ::STRINGS[16/*"C:\\Users\\...*/], 41, ::STRINGS[2/*"Perform"*/], NULL);
        return;
    }
...
void TransitionLayout__Perform_fn(TransitionLayout* __this, ::g::Fuse::Node* target)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[17/*"Missing `Fr...*/], __this, ::STRINGS[18/*"C:\\Users\\...*/], 355, ::STRINGS[2/*"Perform"*/], NULL);
        return;
    }
...
void TransitionState__Perform_fn(TransitionState* __this, ::g::Fuse::Node* target)
{
    ...
    if (t == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[19/*"Missing `Ta...*/], __this, ::STRINGS[20/*"C:\\Users\\...*/], 24, ::STRINGS[2/*"Perform"*/], NULL);
        return;
    }
