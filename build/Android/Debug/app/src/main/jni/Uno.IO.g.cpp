...
{
    return ::g::Uno::IO::FileStream::New2(::g::Uno::IO::FILEPtr::OpenOrThrow(filename, ::STRINGS[23/*"wb"*/]), false, true);
}
...
{
    ::STRINGS[16] = uString::Const("filename");
    ::STRINGS[24] = uString::Const("Can't open file: ");
}
...
{
    U_THROW(::g::Uno::IO::FileNotFoundException::New5(::g::Uno::String::op_Addition2(::STRINGS[24/*"Can't open ...*/], filename), filename));
}
// }
...
{
    ::STRINGS[25] = uString::Const("The file stream was closed");
    ::STRINGS[26] = uString::Const("File not found: ");
    ::STRINGS[23] = uString::Const("wb");
...
{
    if (!this->_fp)
        U_THROW(::g::Uno::ObjectDisposedException::New4(::STRINGS[25/*"The file st...*/]));
}
    ...
    switch (mode)
    {
        case 5:
        {
            if (!::g::Uno::IO::File::Exists(filename))
                U_THROW(::g::Uno::IO::FileNotFoundException::New5(::g::Uno::String::op_Addition2(::STRINGS[26/*"File not fo...*/], filename), filename));

            _canRead = true;
            _canWrite = true;
            fclose(::g::Uno::IO::FILEPtr::OpenOrThrow(filename, ::STRINGS[23/*"wb"*/]));
