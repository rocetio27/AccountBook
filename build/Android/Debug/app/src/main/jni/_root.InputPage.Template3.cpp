...
// {
// static Template3() :104
static void InputPage__Template3__cctor__fn(uType* __type)
{
    ::g::Uno::UX::Selector_typeof()->Init();
    InputPage__Template3::__selector0_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[0/*"IsEnabled"*/]);
    InputPage__Template3::__selector1_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[1/*"Text"*/]);
}

static void InputPage__Template3_build(uType* type)
{
    ...
    type->SetFields(2,
        ::g::InputPage_typeof(), offsetof(InputPage__Template3, __parent1), uFieldFlagsWeak,
        ::g::InputPage_typeof(), offsetof(InputPage__Template3, __parentInstance1), uFieldFlagsWeak,
        ::g::Uno::UX::Property1_typeof()->MakeType(::g::Uno::Bool_typeof(), NULL), offsetof(InputPage__Template3, ModalConfirm_IsEnabled_inst), 0,
        ::g::Uno::UX::Property1_typeof()->MakeType(::g::Uno::String_typeof(), NULL), offsetof(InputPage__Template3, temp_Text_inst), 0,
        ::g::Fuse::Reactive::EventBinding_typeof(), offsetof(InputPage__Template3, temp_eb15), 0,
        ::g::Fuse::Reactive::EventBinding_typeof(), offsetof(InputPage__Template3, temp_eb16), 0,
        ::g::Uno::UX::Selector_typeof(), (uintptr_t)&InputPage__Template3::__selector0_, uFieldFlagsStatic,
        ::g::Uno::UX::Selector_typeof(), (uintptr_t)&InputPage__Template3::__selector1_, uFieldFlagsStatic);
}
...
::g::Uno::UX::Template_type* InputPage__Template3_typeof()
{
    ...
    options.ObjectSize = sizeof(InputPage__Template3);
    options.TypeSize = sizeof(::g::Uno::UX::Template_type);
    type = (::g::Uno::UX::Template_type*)uClassType::New("InputPage.Template3", options);
    type->fp_build_ = InputPage__Template3_build;
    type->fp_cctor_ = InputPage__Template3__cctor__fn;
    type->fp_New1 = (void(*)(::g::Uno::UX::Template*, uObject**))InputPage__Template3__New1_fn;
    return type;
}

// public Template3(InputPage parent, InputPage parentInstance) :95
...
void InputPage__Template3__New1_fn(InputPage__Template3* __this, uObject** __retval)
{
    ...
    __this->ModalConfirm_IsEnabled_inst = ::g::AccountBook_FuseAlternateRoot_IsEnabled_Property::New1(uPtr(__this->__parent1)->ModalConfirm, InputPage__Template3::__selector0_);
    ::g::Fuse::Reactive::Data* temp1 = ::g::Fuse::Reactive::Data::New1(::STRINGS[2/*"SelectUsage"*/]);
    ::g::wbButton_Left* temp = ::g::wbButton_Left::New6();
    __this->temp_Text_inst = ::g::AccountBook_FuseControlsButtonBase_Text_Property::New1(temp, InputPage__Template3::__selector1_);
    ...
    temp11->Y(1.0f);
    temp11->Duration(0.4);
    temp11->RelativeTo(::g::Fuse::Triggers::LayoutTransition::PositionLayoutChange_);
    temp11->Easing(::g::Fuse::Animations::Easing::ElasticIn_);
    ...
    temp13->X(1.0f);
    temp13->Duration(0.3);
    temp13->RelativeTo(::g::Fuse::TranslationModes::Size_);
    temp13->Easing(::g::Fuse::Animations::Easing::CircularIn_);
    ...
    temp15->X(-1.0f);
    temp15->Duration(0.4);
    temp15->RelativeTo(::g::Fuse::TranslationModes::Size_);
...
// public Template3 New(InputPage parent, InputPage parentInstance) :95
void InputPage__Template3__New2_fn(::g::InputPage* parent, ::g::InputPage* parentInstance, InputPage__Template3** __retval)
{
    *__retval = InputPage__Template3::New2(parent, parentInstance);
}

::g::Uno::UX::Selector InputPage__Template3::__selector0_;
::g::Uno::UX::Selector InputPage__Template3::__selector1_;

// public Template3(InputPage parent, InputPage parentInstance) [instance] :95
void InputPage__Template3::ctor_1(::g::InputPage* parent, ::g::InputPage* parentInstance)
{
    ctor_(NULL, false);
    __parent1 = parent;
...
// public Template3 New(InputPage parent, InputPage parentInstance) [static] :95
InputPage__Template3* InputPage__Template3::New2(::g::InputPage* parent, ::g::InputPage* parentInstance)
{
    InputPage__Template3* obj1 = (InputPage__Template3*)uNew(InputPage__Template3_typeof());
