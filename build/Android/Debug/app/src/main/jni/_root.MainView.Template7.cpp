...
// public partial sealed class MainView.Template7 :644
// {
// static Template7() :658
static void MainView__Template7__cctor__fn(uType* __type)
{
    ::g::Uno::UX::Selector_typeof()->Init();
    MainView__Template7::__selector0_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[0/*"Element.Lay...*/]);
    MainView__Template7::__selector1_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[1/*"Margin"*/]);
    MainView__Template7::__selector2_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[2/*"statisticPa...*/]);
}
...
static void MainView__Template7_build(uType* type)
{
    ...
    ::STRINGS[3] = uString::Const("listPanel");
    ::STRINGS[4] = uString::Const("budgetPanel");
    ::STRINGS[5] = uString::Const("budget");
...
void MainView__Template7__New1_fn(MainView__Template7* __this, uObject** __retval)
{
    ...
    temp2->From(::STRINGS[4/*"budgetPanel"*/]);
    ...
    temp4->Direction(2);
    temp4->How(2);
    temp4->Bookmark(::STRINGS[5/*"budget"*/]);
    temp5->Direction(4);
    temp5->How(2);
    temp5->Bookmark(::STRINGS[6/*"list"*/]);
...
// public Template7 New(MainView parent, MainView parentInstance) :648
...
// public Template7(MainView parent, MainView parentInstance) [instance] :648
...
// public Template7 New(MainView parent, MainView parentInstance) [static] :648
