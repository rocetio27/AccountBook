...
// public partial sealed class MainView.Template8 :720
// {
// static Template8() :734
static void MainView__Template8__cctor__fn(uType* __type)
{
    ::g::Uno::UX::Selector_typeof()->Init();
    MainView__Template8::__selector0_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[0/*"Element.Lay...*/]);
    MainView__Template8::__selector1_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[1/*"Margin"*/]);
    MainView__Template8::__selector2_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[2/*"budgetPanel"*/]);
}
...
static void MainView__Template8_build(uType* type)
{
    ...
    ::STRINGS[3] = uString::Const("statisticPanel");
    ::STRINGS[4] = uString::Const("inputPanel");
    ::STRINGS[5] = uString::Const("input");
...
void MainView__Template8__New1_fn(MainView__Template8* __this, uObject** __retval)
{
    ...
    temp2->From(::STRINGS[4/*"inputPanel"*/]);
    ...
    temp4->Direction(2);
    temp4->How(2);
    temp4->Bookmark(::STRINGS[5/*"input"*/]);
    temp5->Direction(4);
    temp5->How(2);
    temp5->Bookmark(::STRINGS[6/*"statistic"*/]);
...
// public Template8 New(MainView parent, MainView parentInstance) :724
...
// public Template8(MainView parent, MainView parentInstance) [instance] :724
...
// public Template8 New(MainView parent, MainView parentInstance) [static] :724
