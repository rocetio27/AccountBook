// This file was generated based on C:/Users/SpaceJockey27/Documents/Fuse/AccountBook/.uno/ux13/dayButton.g.uno.
...
static void dayButton__cctor_5_fn(uType* __type)
{
    ...
    dayButton::__selector0_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[0/*"FontSize"*/]);
    dayButton::__selector1_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[1/*"Color"*/]);
    dayButton::__selector2_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[2/*"Value"*/]);
    dayButton::__selector3_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[3/*"textcolor"*/]);
}
...
void dayButton__get_fontsize_fn(dayButton* __this, int* __retval)
{
    *__retval = __this->fontsize();
}

// public void set_fontsize(int value) :39
void dayButton__set_fontsize_fn(dayButton* __this, int* value)
{
...
void dayButton__Setfontsize_fn(dayButton* __this, int* value, uObject* origin)
{
...
void dayButton::InitializeUX1()
{
    ...
    ::g::Fuse::Reactive::Property* temp2 = ::g::Fuse::Reactive::Property::New1(temp1, ::g::AccountBook_accessor_dayButton_fontsize::Singleton_);
    ...
    ::g::Fuse::Reactive::Property* temp4 = ::g::Fuse::Reactive::Property::New1(temp3, ::g::AccountBook_accessor_dayButton_textcolor::Singleton_);
    ...
    ::g::Fuse::Reactive::Property* temp6 = ::g::Fuse::Reactive::Property::New1(temp5, ::g::AccountBook_accessor_dayButton_text::Singleton_);
...
void dayButton::Setfontsize(int value, uObject* origin)
{
