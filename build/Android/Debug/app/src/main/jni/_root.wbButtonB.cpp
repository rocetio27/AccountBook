...
static void wbButtonB__cctor_5_fn(uType* __type)
{
    ...
    wbButtonB::__selector0_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[0/*"Value"*/]);
    wbButtonB::__selector1_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[1/*"Color"*/]);
    wbButtonB::__selector2_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[2/*"wbRec"*/]);
}
...
void wbButtonB::InitializeUX1()
{
    ...
    ::g::Fuse::Reactive::Property* temp4 = ::g::Fuse::Reactive::Property::New1(temp3, ::g::AccountBook_accessor_wbButtonB_textcolor::Singleton_);
    ...
    textcolor(::g::Fuse::Drawing::Colors::Black_);
    uPtr(wbRec)->CornerRadius(::g::Uno::Float4__New2(5.0f, 5.0f, 5.0f, 5.0f));
    uPtr(wbRec)->Color(::g::Fuse::Drawing::Colors::White_);
