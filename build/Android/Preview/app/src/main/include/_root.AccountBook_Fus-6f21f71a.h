...
namespace g{struct AccountBook_FuseAlternateRoot_ParentNode_Property;}
...
struct AccountBook_FuseAlternateRoot_ParentNode_Property : ::g::Uno::UX::Property1
{
    uWeak< ::g::Fuse::AlternateRoot*> _obj;

    void ctor_3(::g::Fuse::AlternateRoot* obj, ::g::Uno::UX::Selector name);
    static AccountBook_FuseAlternateRoot_ParentNode_Property* New1(::g::Fuse::AlternateRoot* obj, ::g::Uno::UX::Selector name);
};
// }
