...
namespace g{struct AccountBook_accessor_dayButton_textcolor;}
...
struct AccountBook_accessor_dayButton_textcolor : ::g::Uno::UX::PropertyAccessor
{
    static uSStrong< ::g::Uno::UX::PropertyAccessor*> Singleton_;
    static uSStrong< ::g::Uno::UX::PropertyAccessor*>& Singleton() { return AccountBook_accessor_dayButton_textcolor_typeof()->Init(), Singleton_; }
    static ::g::Uno::UX::Selector _name_;
    static ::g::Uno::UX::Selector& _name() { return AccountBook_accessor_dayButton_textcolor_typeof()->Init(), _name_; }

    void ctor_1();
    static AccountBook_accessor_dayButton_textcolor* New1();
};
// }
