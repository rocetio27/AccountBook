...
namespace g{struct AccountBook_dayButton_text_Property;}
...
struct AccountBook_dayButton_text_Property : ::g::Uno::UX::Property1
{
    uWeak< ::g::dayButton*> _obj;

    void ctor_3(::g::dayButton* obj, ::g::Uno::UX::Selector name);
    static AccountBook_dayButton_text_Property* New1(::g::dayButton* obj, ::g::Uno::UX::Selector name);
};
// }
