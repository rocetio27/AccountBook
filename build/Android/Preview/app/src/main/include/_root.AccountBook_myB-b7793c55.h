...
namespace g{struct AccountBook_myButton_textcolor_Property;}
...
struct AccountBook_myButton_textcolor_Property : ::g::Uno::UX::Property1
{
    uWeak< ::g::myButton*> _obj;

    void ctor_3(::g::myButton* obj, ::g::Uno::UX::Selector name);
    static AccountBook_myButton_textcolor_Property* New1(::g::myButton* obj, ::g::Uno::UX::Selector name);
};
// }
