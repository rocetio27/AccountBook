...
struct ListPage__Template2__Template4 : ::g::Uno::UX::Template
{
    ...
    static ::g::Uno::UX::Selector& __selector0() { return ListPage__Template2__Template4_typeof()->Init(), __selector0_; }

    void ctor_1(::g::ListPage__Template2* parent, ::g::Fuse::Controls::Rectangle* parentInstance);
    static ListPage__Template2__Template4* New2(::g::ListPage__Template2* parent, ::g::Fuse::Controls::Rectangle* parentInstance);
};
// }
