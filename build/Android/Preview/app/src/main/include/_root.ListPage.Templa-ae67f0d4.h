...
struct ListPage__Template2__Template3__Template4__Template5 : ::g::Uno::UX::Template
{
    ...
    static ::g::Uno::UX::Selector& __selector0() { return ListPage__Template2__Template3__Template4__Template5_typeof()->Init(), __selector0_; }

    void ctor_1(::g::ListPage__Template2__Template3__Template4* parent, ::g::Fuse::Reactive::Each* parentInstance);
    static ListPage__Template2__Template3__Template4__Template5* New2(::g::ListPage__Template2__Template3__Template4* parent, ::g::Fuse::Reactive::Each* parentInstance);
};
// }
