...
static void JSList_build(uType* type)
{
    ...
    type->Reflection.SetFunctions(3,
        new uFunction("FromJava", NULL, (void*)JSList__FromJava_fn, 0, false, uVoid_typeof(), 1, ::g::Java::Object_typeof()),
        new uFunction("GetScriptingArray", NULL, (void*)JSList__GetScriptingArray_fn, 0, false, ::TYPES[0/*Fuse.Scripting.Array*/], 0),
        new uFunction(".ctor", NULL, (void*)JSList__New1_fn, 0, true, type, 1, ::g::Fuse::Scripting::Context_typeof()));
}
...
{
    uStackFrame __("Bolav.ForeignHelpers.JSList", "NewDictRow()");
...
{
    uStackFrame __("Bolav.ForeignHelpers.JSList", ".ctor(Fuse.Scripting.Context)");
    ctor_();
    ctx = c;
