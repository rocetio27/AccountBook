...
// C:\Users\SpaceJockey27\AppData\Local\Fusetools\Packages\Fuse.Selection\1.9.0\Selected.uno
// -----------------------------------------------------------------------------------------
...
void Selection::Values(uObject* value)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserError(uString::Const("`Values` must be an IObservableArray"), this, uString::Const("C:\\Users\\SpaceJockey27\\AppData\\Local\\Fusetools\\Packages\\Fuse.Selection\\1.9.0\\Selection.uno"), 394, uString::Const("set_Values"), NULL);
        return;
    }
...
{
    ::STRINGS[0] = uString::Const("Unable to locate a `Selectable` and `Selection`");
    ::STRINGS[16] = uString::Const("C:\\Users\\SpaceJockey27\\AppData\\Local\\Fusetools\\Packages\\Fuse.Selection\\1.9.0\\Selected.uno");
    ::STRINGS[13] = uString::Const("OnRooted");
    ::TYPES[0] = ::g::Uno::EventHandler_typeof();
...
void SelectionEvent__OnRooted_fn(SelectionEvent* __this)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[0/*"Unable to l...*/], __this, ::STRINGS[16/*"C:\\Users\\...*/], 41, ::STRINGS[13/*"OnRooted"*/], NULL);
        return;
    }
...
static void ToggleSelection_build(uType* type)
{
    ...
    ::STRINGS[19] = uString::Const("C:\\Users\\SpaceJockey27\\AppData\\Local\\Fusetools\\Packages\\Fuse.Selection\\1.9.0\\ToggleSelection.uno");
...
// C:\Users\SpaceJockey27\AppData\Local\Fusetools\Packages\Fuse.Selection\1.9.0\WhileSelected.uno
// ----------------------------------------------------------------------------------------------
...
{
    ::STRINGS[0] = uString::Const("Unable to locate a `Selectable` and `Selection`");
    ::STRINGS[21] = uString::Const("C:\\Users\\SpaceJockey27\\AppData\\Local\\Fusetools\\Packages\\Fuse.Selection\\1.9.0\\WhileSelected.uno");
    ::STRINGS[13] = uString::Const("OnRooted");
    ::TYPES[0] = ::g::Uno::EventHandler_typeof();
    type->SetDependencies(
        ::g::Fuse::Selection::Selection_typeof());
...
void WhileSelected__OnRooted_fn(WhileSelected* __this)
{
    ...
    if (!::g::Fuse::Selection::Selection::TryFindSelectable(__this->Parent(), &__this->_selectable, &__this->_selection))
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[0/*"Unable to l...*/], __this, ::STRINGS[21/*"C:\\Users\\...*/], 28, ::STRINGS[13/*"OnRooted"*/], NULL);
        return;
    }
