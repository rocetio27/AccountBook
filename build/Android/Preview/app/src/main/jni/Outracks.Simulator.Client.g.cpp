...
// C:\Users\SpaceJockey27\AppData\Local\Fusetools\Packages\Fuse.Preview.Core\0.1.0\Application.uno
// -----------------------------------------------------------------------------------------------
...
static void Application_build(uType* type)
{
    ...
    ::STRINGS[1] = uString::Const("C:\\Users\\SpaceJockey27\\AppData\\Local\\Fusetools\\Packages\\Fuse.Preview.Core\\0.1.0\\Application.uno");
...
void Application::ResetEverything(bool initial, uObject* overlay)
{
    ...
    catch (const uThrowable& __t)
    {
        ...
        ::g::Fuse::Diagnostics::UnknownException(::STRINGS[0/*"Failed to p...*/], e, this, ::STRINGS[1/*"C:\\Users\\...*/], 120, ::STRINGS[2/*"ResetEveryt...*/]);
    }
...
// C:\Users\SpaceJockey27\AppData\Local\Fusetools\Packages\Fuse.Preview.Core\0.1.0\ApplicationStates.uno
// -----------------------------------------------------------------------------------------------------
...
// C:\Users\SpaceJockey27\AppData\Local\Fusetools\Packages\Fuse.Preview.Core\0.1.0\Context.uno
// -------------------------------------------------------------------------------------------
...
// C:\Users\SpaceJockey27\AppData\Local\Fusetools\Packages\Fuse.Preview.Core\0.1.0\Reflection\NativeReflection.uno
// ---------------------------------------------------------------------------------------------------------------
...
// C:\Users\SpaceJockey27\AppData\Local\Fusetools\Packages\Fuse.Preview.Core\0.1.0\DeviceInfo.uno
// ----------------------------------------------------------------------------------------------
...
{
    {
        ...
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "GetGUID389", "()Ljava/lang/String;");
...
{
    {
        INIT_JNI;
        jclass __cls = JniHelper::GetNativeExternClass();
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "GetName390", "()Ljava/lang/String;");
        jobject __jresult = U_JNIVAR->CallStaticObjectMethod(__cls,__mtd);
        uString* __result = JniHelper::JavaToUnoString((jstring)__jresult);
        if (__jresult!=NULL && U_JNIVAR->GetObjectRefType(__jresult) == JNILocalRefType) U_JNIVAR->DeleteLocalRef(__jresult);
        ::g::Android::Base::JNI::CheckException();
...
// C:\Users\SpaceJockey27\AppData\Local\Fusetools\Packages\Fuse.Preview.Core\0.1.0\ModalDialog.uno
// -----------------------------------------------------------------------------------------------
...
// C:\Users\SpaceJockey27\AppData\Local\Fusetools\Packages\Fuse.Preview.Core\0.1.0\Reflection\DotNetReflection.uno
// ---------------------------------------------------------------------------------------------------------------
...
// C:\Users\SpaceJockey27\AppData\Local\Fusetools\Packages\Fuse.Preview.Core\0.1.0\FakeApp.uno
// -------------------------------------------------------------------------------------------
...
// C:\Users\SpaceJockey27\AppData\Local\Fusetools\Packages\Fuse.Preview.Core\0.1.0\Reflection\ReflectionCache.uno
// --------------------------------------------------------------------------------------------------------------
...
// C:\Users\SpaceJockey27\AppData\Local\Fusetools\Packages\Fuse.Preview.Core\0.1.0\Reflection\ReflectionExtensions.uno
// -------------------------------------------------------------------------------------------------------------------
...
static void Running_build(uType* type)
{
    ...
    ::STRINGS[37] = uString::Const("C:/Users/SpaceJockey27/AppData/Local/Fusetools/Packages/Fuse.Preview.Core/0.1.0/ApplicationStates.uno");
    ::TYPES[19] = ::g::Outracks::Simulator::ISimulatorClient_typeof();
    ::TYPES[37] = ::g::Outracks::Simulator::Client::DialogButton_typeof()->Array();
    type->SetDependencies(
        ::g::Uno::Diagnostics::Debug_typeof(),
...
void Running__OnUpdate_fn(Running* __this, ::g::Outracks::Simulator::Client::State** __retval)
{
    ...
    {
        ::g::Uno::Diagnostics::Debug::Log3(::STRINGS[36/*"Density cha...*/], 0, ::STRINGS[37/*"C:/Users/Sp...*/], 377);
...
{
    ::STRINGS[38] = uString::Const("C:/Users/SpaceJockey27/AppData/Local/Fusetools/Packages/Fuse.Preview.Core/0.1.0/ModalDialog.uno");
...
void ShowingModalDialog__OnException_fn(ShowingModalDialog* __this, ::g::Uno::Exception* e, ::g::Outracks::Simulator::Client::State** __retval)
{
    ...
    ::g::Uno::Diagnostics::Debug::Log3(uPtr(e)->Message(), 0, ::STRINGS[38/*"C:/Users/Sp...*/], 226);
    return *__retval = __this, void();
}
...
void ShowingPrompt__OnEnterState_fn(ShowingPrompt* __this, ::g::Outracks::Simulator::Client::State** __retval)
{
    ...
    ::g::Uno::Diagnostics::Debug::Log3(::g::Uno::String::op_Addition2(::STRINGS[41/*"# "*/], __this->_header), 0, ::STRINGS[38/*"C:/Users/Sp...*/], 136);
    ::g::Uno::Diagnostics::Debug::Log3(__this->_body, 0, ::STRINGS[38/*"C:/Users/Sp...*/], 137);
...
// C:\Users\SpaceJockey27\AppData\Local\Fusetools\Packages\Fuse.Preview.Core\0.1.0\UserAppState.uno
// ------------------------------------------------------------------------------------------------
