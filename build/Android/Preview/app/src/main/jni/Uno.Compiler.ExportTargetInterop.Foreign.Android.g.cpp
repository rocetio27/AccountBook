...
jobject JNICALL callUno_Bolav_ForeignHelpers_ForeignList_NewDictRow401(JNIEnv *env,jclass clazz,jobject jthis)
{
    uAutoReleasePool pool;
    INIT_JNI;
    ::g::Bolav::ForeignHelpers::ForeignList* uno_jthis = uCast<::g::Bolav::ForeignHelpers::ForeignList*>(::g::Uno::Compiler::ExportTargetInterop::Foreign::Android::JavaUnoObject::UnBox(jthis), ::g::Bolav::ForeignHelpers::ForeignList_typeof());
    jobject __jresult;
    JTRY
        ::g::Bolav::ForeignHelpers::ForeignDict* __result=uno_jthis->NewDictRow();
...
jobject JNICALL callUno_Bolav_ForeignHelpers_JSDict_AddDictForKey393(JNIEnv *env,jclass clazz,jobject jthis,jobject key)
{
    uAutoReleasePool pool;
    INIT_JNI;
    ::g::Bolav::ForeignHelpers::JSDict* uno_jthis = uCast<::g::Bolav::ForeignHelpers::JSDict*>(::g::Uno::Compiler::ExportTargetInterop::Foreign::Android::JavaUnoObject::UnBox(jthis), ::g::Bolav::ForeignHelpers::JSDict_typeof());
    uString* uno_key = JniHelper::JavaToUnoString((jstring)key);
    jobject __jresult;
    JTRY
        ::g::Bolav::ForeignHelpers::ForeignDict* __result=uno_jthis->AddDictForKey(uCast<uString*>(uno_key, ::g::Uno::String_typeof()));
        __jresult = (__result==NULL ? NULL : U_JNIVAR->NewLocalRef((::g::Uno::Compiler::ExportTargetInterop::Foreign::Android::JavaUnoObject::Box6(__result))));
    JCATCH
    return __jresult;
}
jobject JNICALL callUno_Bolav_ForeignHelpers_JSDict_AddListForKey394(JNIEnv *env,jclass clazz,jobject jthis,jobject key)
{
    uAutoReleasePool pool;
    INIT_JNI;
    ::g::Bolav::ForeignHelpers::JSDict* uno_jthis = uCast<::g::Bolav::ForeignHelpers::JSDict*>(::g::Uno::Compiler::ExportTargetInterop::Foreign::Android::JavaUnoObject::UnBox(jthis), ::g::Bolav::ForeignHelpers::JSDict_typeof());
    ...
    jobject __jresult;
    JTRY
        ::g::Bolav::ForeignHelpers::ForeignList* __result=uno_jthis->AddListForKey(uCast<uString*>(uno_key, ::g::Uno::String_typeof()));
        __jresult = (__result==NULL ? NULL : U_JNIVAR->NewLocalRef((::g::Uno::Compiler::ExportTargetInterop::Foreign::Android::JavaUnoObject::Box6(__result))));
    JCATCH
    return __jresult;
}
jobject JNICALL callUno_Bolav_ForeignHelpers_JSList_NewDictRow396(JNIEnv *env,jclass clazz,jobject jthis)
{
    uAutoReleasePool pool;
    INIT_JNI;
    ::g::Bolav::ForeignHelpers::JSList* uno_jthis = uCast<::g::Bolav::ForeignHelpers::JSList*>(::g::Uno::Compiler::ExportTargetInterop::Foreign::Android::JavaUnoObject::UnBox(jthis), ::g::Bolav::ForeignHelpers::JSList_typeof());
    jobject __jresult;
    JTRY
        ::g::Bolav::ForeignHelpers::ForeignDict* __result=uno_jthis->NewDictRow();
        __jresult = (__result==NULL ? NULL : U_JNIVAR->NewLocalRef((::g::Uno::Compiler::ExportTargetInterop::Foreign::Android::JavaUnoObject::Box6(__result))));
...
void JNICALL callUno_Bolav_ForeignHelpers_ForeignDict_SetKeyVal402(JNIEnv *env,jclass clazz,jobject jthis,jobject key,jobject val)
{
    uAutoReleasePool pool;
    INIT_JNI;
    ::g::Bolav::ForeignHelpers::ForeignDict* uno_jthis = uCast<::g::Bolav::ForeignHelpers::ForeignDict*>(::g::Uno::Compiler::ExportTargetInterop::Foreign::Android::JavaUnoObject::UnBox(jthis), ::g::Bolav::ForeignHelpers::ForeignDict_typeof());
    uString* uno_key = JniHelper::JavaToUnoString((jstring)key);
    uString* uno_val = JniHelper::JavaToUnoString((jstring)val);
    JTRY
...
void JNICALL callUno_Bolav_ForeignHelpers_JSDict_SetKeyVal392(JNIEnv *env,jclass clazz,jobject jthis,jobject key,jobject val)
{
    uAutoReleasePool pool;
    INIT_JNI;
    ::g::Bolav::ForeignHelpers::JSDict* uno_jthis = uCast<::g::Bolav::ForeignHelpers::JSDict*>(::g::Uno::Compiler::ExportTargetInterop::Foreign::Android::JavaUnoObject::UnBox(jthis), ::g::Bolav::ForeignHelpers::JSDict_typeof());
...
void ExternBlockHost::RegisterFunctions()
{
    ...
    {(char* const)"callUno_Bolav_ForeignHelpers_JSDict_SetKeyVal392", (char* const)"(Lcom/uno/UnoObject;Ljava/lang/String;Ljava/lang/String;)V", (void *)&callUno_Bolav_ForeignHelpers_JSDict_SetKeyVal392},
    {(char* const)"callUno_Bolav_ForeignHelpers_JSDict_AddDictForKey393", (char* const)"(Lcom/uno/UnoObject;Ljava/lang/String;)Lcom/uno/UnoObject;", (void *)&callUno_Bolav_ForeignHelpers_JSDict_AddDictForKey393},
    {(char* const)"callUno_Bolav_ForeignHelpers_JSDict_AddListForKey394", (char* const)"(Lcom/uno/UnoObject;Ljava/lang/String;)Lcom/uno/UnoObject;", (void *)&callUno_Bolav_ForeignHelpers_JSDict_AddListForKey394},
    {(char* const)"callUno_Bolav_ForeignHelpers_JSList_NewDictRow396", (char* const)"(Lcom/uno/UnoObject;)Lcom/uno/UnoObject;", (void *)&callUno_Bolav_ForeignHelpers_JSList_NewDictRow396},
    {(char* const)"callUno_Bolav_ForeignHelpers_ForeignList_NewDictRow401", (char* const)"(Lcom/uno/UnoObject;)Lcom/uno/UnoObject;", (void *)&callUno_Bolav_ForeignHelpers_ForeignList_NewDictRow401},
    {(char* const)"callUno_Bolav_ForeignHelpers_ForeignDict_SetKeyVal402", (char* const)"(Lcom/uno/UnoObject;Ljava/lang/String;Ljava/lang/String;)V", (void *)&callUno_Bolav_ForeignHelpers_ForeignDict_SetKeyVal402},
    };
    int funcCount = 131;
