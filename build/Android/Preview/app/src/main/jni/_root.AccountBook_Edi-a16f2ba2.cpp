...
// public AccountBook_EditButton_text_Property(EditButton obj, Uno.UX.Selector name) :363
...
// public override sealed string Get(Uno.UX.PropertyObject obj) :365
...
{
    uStackFrame __("AccountBook_EditButton_text_Property", "Get(Uno.UX.PropertyObject)");
    return *__retval = uPtr(uCast< ::g::EditButton*>(obj, ::TYPES[0/*EditButton*/]))->text(), void();
}

// public AccountBook_EditButton_text_Property New(EditButton obj, Uno.UX.Selector name) :363
...
// public override sealed void Set(Uno.UX.PropertyObject obj, string v, Uno.UX.IPropertyListener origin) :366
...
{
    uStackFrame __("AccountBook_EditButton_text_Property", "Set(Uno.UX.PropertyObject,string,Uno.UX.IPropertyListener)");
    uPtr(uCast< ::g::EditButton*>(obj, ::TYPES[0/*EditButton*/]))->Settext(v, origin);
}

// public override sealed bool get_SupportsOriginSetter() :367
...
// public AccountBook_EditButton_text_Property(EditButton obj, Uno.UX.Selector name) [instance] :363
...
// public AccountBook_EditButton_text_Property New(EditButton obj, Uno.UX.Selector name) [static] :363
