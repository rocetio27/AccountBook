...
// internal sealed class AccountBook_FuseReactiveEach_Limit_Property :317
// {
...
// public AccountBook_FuseReactiveEach_Limit_Property(Fuse.Reactive.Each obj, Uno.UX.Selector name) :320
...
// public override sealed int Get(Uno.UX.PropertyObject obj) :322
...
{
    uStackFrame __("AccountBook_FuseReactiveEach_Limit_Property", "Get(Uno.UX.PropertyObject)");
    return *__retval = uPtr(uCast< ::g::Fuse::Reactive::Each*>(obj, ::TYPES[0/*Fuse.Reactive.Each*/]))->Limit1(), void();
}

// public AccountBook_FuseReactiveEach_Limit_Property New(Fuse.Reactive.Each obj, Uno.UX.Selector name) :320
...
// public override sealed Uno.UX.PropertyObject get_Object() :321
...
// public override sealed void Set(Uno.UX.PropertyObject obj, int v, Uno.UX.IPropertyListener origin) :323
...
{
    uStackFrame __("AccountBook_FuseReactiveEach_Limit_Property", "Set(Uno.UX.PropertyObject,int,Uno.UX.IPropertyListener)");
    int32_t v_ = *v;
    uPtr(uCast< ::g::Fuse::Reactive::Each*>(obj, ::TYPES[0/*Fuse.Reactive.Each*/]))->Limit1(v_);
}

// public AccountBook_FuseReactiveEach_Limit_Property(Fuse.Reactive.Each obj, Uno.UX.Selector name) [instance] :320
...
// public AccountBook_FuseReactiveEach_Limit_Property New(Fuse.Reactive.Each obj, Uno.UX.Selector name) [static] :320
