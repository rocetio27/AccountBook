...
// internal sealed class AccountBook_FuseAlternateRoot_IsEnabled_Property :224
// {
...
// public AccountBook_FuseAlternateRoot_IsEnabled_Property(Fuse.AlternateRoot obj, Uno.UX.Selector name) :227
...
{
    uStackFrame __("AccountBook_FuseAlternateRoot_IsEnabled_Property", "Get(Uno.UX.PropertyObject)");
    return *__retval = uPtr(uCast< ::g::Fuse::AlternateRoot*>(obj, ::TYPES[0/*Fuse.AlternateRoot*/]))->IsEnabled(), void();
}

// public AccountBook_FuseAlternateRoot_IsEnabled_Property New(Fuse.AlternateRoot obj, Uno.UX.Selector name) :227
...
{
    uStackFrame __("AccountBook_FuseAlternateRoot_IsEnabled_Property", "Set(Uno.UX.PropertyObject,bool,Uno.UX.IPropertyListener)");
    bool v_ = *v;
    uPtr(uCast< ::g::Fuse::AlternateRoot*>(obj, ::TYPES[0/*Fuse.AlternateRoot*/]))->IsEnabled(v_);
}

// public AccountBook_FuseAlternateRoot_IsEnabled_Property(Fuse.AlternateRoot obj, Uno.UX.Selector name) [instance] :227
...
// public AccountBook_FuseAlternateRoot_IsEnabled_Property New(Fuse.AlternateRoot obj, Uno.UX.Selector name) [static] :227
