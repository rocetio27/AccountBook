...
// internal sealed class AccountBook_FuseElementsElement_Visibility_Property :265
// {
static void AccountBook_FuseElementsElement_Visibility_Property_build(uType* type)
{
    ...
    type->SetFields(1,
        ::TYPES[0/*Fuse.Elements.Element*/], offsetof(AccountBook_FuseElementsElement_Visibility_Property, _obj), uFieldFlagsWeak);
}

::g::Uno::UX::Property1_type* AccountBook_FuseElementsElement_Visibility_Property_typeof()
{
    ...
    options.ObjectSize = sizeof(AccountBook_FuseElementsElement_Visibility_Property);
    options.TypeSize = sizeof(::g::Uno::UX::Property1_type);
    type = (::g::Uno::UX::Property1_type*)uClassType::New("AccountBook_FuseElementsElement_Visibility_Property", options);
    type->fp_build_ = AccountBook_FuseElementsElement_Visibility_Property_build;
    type->fp_Get1 = (void(*)(::g::Uno::UX::Property1*, ::g::Uno::UX::PropertyObject*, uTRef))AccountBook_FuseElementsElement_Visibility_Property__Get1_fn;
    type->fp_get_Object = (void(*)(::g::Uno::UX::Property*, ::g::Uno::UX::PropertyObject**))AccountBook_FuseElementsElement_Visibility_Property__get_Object_fn;
    type->fp_Set1 = (void(*)(::g::Uno::UX::Property1*, ::g::Uno::UX::PropertyObject*, void*, uObject*))AccountBook_FuseElementsElement_Visibility_Property__Set1_fn;
    type->fp_get_SupportsOriginSetter = (void(*)(::g::Uno::UX::PropertyAccessor*, bool*))AccountBook_FuseElementsElement_Visibility_Property__get_SupportsOriginSetter_fn;
    return type;
}

// public AccountBook_FuseElementsElement_Visibility_Property(Fuse.Elements.Element obj, Uno.UX.Selector name) :268
...
// public override sealed Fuse.Elements.Visibility Get(Uno.UX.PropertyObject obj) :270
...
{
    uStackFrame __("AccountBook_FuseElementsElement_Visibility_Property", "Get(Uno.UX.PropertyObject)");
    return *__retval = uPtr(uCast< ::g::Fuse::Elements::Element*>(obj, ::TYPES[0/*Fuse.Elements.Element*/]))->Visibility(), void();
}

// public AccountBook_FuseElementsElement_Visibility_Property New(Fuse.Elements.Element obj, Uno.UX.Selector name) :268
...
// public override sealed void Set(Uno.UX.PropertyObject obj, Fuse.Elements.Visibility v, Uno.UX.IPropertyListener origin) :271
...
{
    uStackFrame __("AccountBook_FuseElementsElement_Visibility_Property", "Set(Uno.UX.PropertyObject,Fuse.Elements.Visibility,Uno.UX.IPropertyListener)");
    int32_t v_ = *v;
...
// public AccountBook_FuseElementsElement_Visibility_Property(Fuse.Elements.Element obj, Uno.UX.Selector name) [instance] :268
...
// public AccountBook_FuseElementsElement_Visibility_Property New(Fuse.Elements.Element obj, Uno.UX.Selector name) [static] :268
