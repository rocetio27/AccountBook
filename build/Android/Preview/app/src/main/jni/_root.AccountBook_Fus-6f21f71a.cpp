...
// internal sealed class AccountBook_FuseAlternateRoot_ParentNode_Property :232
// {
...
// public AccountBook_FuseAlternateRoot_ParentNode_Property(Fuse.AlternateRoot obj, Uno.UX.Selector name) :235
...
// public override sealed Fuse.Visual Get(Uno.UX.PropertyObject obj) :237
...
{
    uStackFrame __("AccountBook_FuseAlternateRoot_ParentNode_Property", "Get(Uno.UX.PropertyObject)");
    return *__retval = uPtr(uCast< ::g::Fuse::AlternateRoot*>(obj, ::TYPES[0/*Fuse.AlternateRoot*/]))->ParentNode(), void();
}

// public AccountBook_FuseAlternateRoot_ParentNode_Property New(Fuse.AlternateRoot obj, Uno.UX.Selector name) :235
...
// public override sealed void Set(Uno.UX.PropertyObject obj, Fuse.Visual v, Uno.UX.IPropertyListener origin) :238
...
{
    uStackFrame __("AccountBook_FuseAlternateRoot_ParentNode_Property", "Set(Uno.UX.PropertyObject,Fuse.Visual,Uno.UX.IPropertyListener)");
    uPtr(uCast< ::g::Fuse::AlternateRoot*>(obj, ::TYPES[0/*Fuse.AlternateRoot*/]))->ParentNode(v);
}

// public AccountBook_FuseAlternateRoot_ParentNode_Property(Fuse.AlternateRoot obj, Uno.UX.Selector name) [instance] :235
...
// public AccountBook_FuseAlternateRoot_ParentNode_Property New(Fuse.AlternateRoot obj, Uno.UX.Selector name) [static] :235
