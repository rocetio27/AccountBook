...
// internal sealed class AccountBook_FuseControlsShadow_Color_Property :378
// {
...
// public AccountBook_FuseControlsShadow_Color_Property(Fuse.Controls.Shadow obj, Uno.UX.Selector name) :381
...
{
    uStackFrame __("AccountBook_FuseControlsShadow_Color_Property", "Get(Uno.UX.PropertyObject)");
    return *__retval = uPtr(uCast< ::g::Fuse::Controls::Shadow*>(obj, ::TYPES[0/*Fuse.Controls.Shadow*/]))->Color(), void();
}

// public AccountBook_FuseControlsShadow_Color_Property New(Fuse.Controls.Shadow obj, Uno.UX.Selector name) :381
...
{
    uStackFrame __("AccountBook_FuseControlsShadow_Color_Property", "Set(Uno.UX.PropertyObject,float4,Uno.UX.IPropertyListener)");
    ::g::Uno::Float4 v_ = *v;
    uPtr(uCast< ::g::Fuse::Controls::Shadow*>(obj, ::TYPES[0/*Fuse.Controls.Shadow*/]))->Color(v_);
}

// public AccountBook_FuseControlsShadow_Color_Property(Fuse.Controls.Shadow obj, Uno.UX.Selector name) [instance] :381
...
// public AccountBook_FuseControlsShadow_Color_Property New(Fuse.Controls.Shadow obj, Uno.UX.Selector name) [static] :381
