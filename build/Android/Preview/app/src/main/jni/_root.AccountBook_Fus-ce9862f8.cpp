...
// internal sealed class AccountBook_FuseControlsImage_Color_Property :249
// {
...
// public AccountBook_FuseControlsImage_Color_Property(Fuse.Controls.Image obj, Uno.UX.Selector name) :252
...
// public override sealed float4 Get(Uno.UX.PropertyObject obj) :254
...
{
    uStackFrame __("AccountBook_FuseControlsImage_Color_Property", "Get(Uno.UX.PropertyObject)");
    return *__retval = uPtr(uCast< ::g::Fuse::Controls::Image*>(obj, ::TYPES[0/*Fuse.Controls.Image*/]))->Color(), void();
}

// public AccountBook_FuseControlsImage_Color_Property New(Fuse.Controls.Image obj, Uno.UX.Selector name) :252
...
// public override sealed void Set(Uno.UX.PropertyObject obj, float4 v, Uno.UX.IPropertyListener origin) :255
...
{
    uStackFrame __("AccountBook_FuseControlsImage_Color_Property", "Set(Uno.UX.PropertyObject,float4,Uno.UX.IPropertyListener)");
    ::g::Uno::Float4 v_ = *v;
    uPtr(uCast< ::g::Fuse::Controls::Image*>(obj, ::TYPES[0/*Fuse.Controls.Image*/]))->Color(v_);
}

// public AccountBook_FuseControlsImage_Color_Property(Fuse.Controls.Image obj, Uno.UX.Selector name) [instance] :252
...
// public AccountBook_FuseControlsImage_Color_Property New(Fuse.Controls.Image obj, Uno.UX.Selector name) [static] :252
