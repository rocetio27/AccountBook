...
// internal sealed class AccountBook_FuseControlsShape_Color_Property :189
// {
static void AccountBook_FuseControlsShape_Color_Property_build(uType* type)
{
    ...
    type->SetFields(1,
        ::TYPES[0/*Fuse.Controls.Shape*/], offsetof(AccountBook_FuseControlsShape_Color_Property, _obj), uFieldFlagsWeak);
}
...
::g::Uno::UX::Property1_type* AccountBook_FuseControlsShape_Color_Property_typeof()
{
    ...
    options.ObjectSize = sizeof(AccountBook_FuseControlsShape_Color_Property);
    options.TypeSize = sizeof(::g::Uno::UX::Property1_type);
    type = (::g::Uno::UX::Property1_type*)uClassType::New("AccountBook_FuseControlsShape_Color_Property", options);
    type->fp_build_ = AccountBook_FuseControlsShape_Color_Property_build;
    type->fp_Get1 = (void(*)(::g::Uno::UX::Property1*, ::g::Uno::UX::PropertyObject*, uTRef))AccountBook_FuseControlsShape_Color_Property__Get1_fn;
    type->fp_get_Object = (void(*)(::g::Uno::UX::Property*, ::g::Uno::UX::PropertyObject**))AccountBook_FuseControlsShape_Color_Property__get_Object_fn;
    type->fp_Set1 = (void(*)(::g::Uno::UX::Property1*, ::g::Uno::UX::PropertyObject*, void*, uObject*))AccountBook_FuseControlsShape_Color_Property__Set1_fn;
    type->fp_get_SupportsOriginSetter = (void(*)(::g::Uno::UX::PropertyAccessor*, bool*))AccountBook_FuseControlsShape_Color_Property__get_SupportsOriginSetter_fn;
    return type;
}

// public AccountBook_FuseControlsShape_Color_Property(Fuse.Controls.Shape obj, Uno.UX.Selector name) :192
...
// public override sealed float4 Get(Uno.UX.PropertyObject obj) :194
...
{
    uStackFrame __("AccountBook_FuseControlsShape_Color_Property", "Get(Uno.UX.PropertyObject)");
    return *__retval = uPtr(uCast< ::g::Fuse::Controls::Shape*>(obj, ::TYPES[0/*Fuse.Controls.Shape*/]))->Color(), void();
}

// public AccountBook_FuseControlsShape_Color_Property New(Fuse.Controls.Shape obj, Uno.UX.Selector name) :192
...
// public override sealed Uno.UX.PropertyObject get_Object() :193
...
// public override sealed void Set(Uno.UX.PropertyObject obj, float4 v, Uno.UX.IPropertyListener origin) :195
...
{
    uStackFrame __("AccountBook_FuseControlsShape_Color_Property", "Set(Uno.UX.PropertyObject,float4,Uno.UX.IPropertyListener)");
    ::g::Uno::Float4 v_ = *v;
    uPtr(uCast< ::g::Fuse::Controls::Shape*>(obj, ::TYPES[0/*Fuse.Controls.Shape*/]))->SetColor(v_, origin);
}

// public override sealed bool get_SupportsOriginSetter() :196
...
// public AccountBook_FuseControlsShape_Color_Property(Fuse.Controls.Shape obj, Uno.UX.Selector name) [instance] :192
...
// public AccountBook_FuseControlsShape_Color_Property New(Fuse.Controls.Shape obj, Uno.UX.Selector name) [static] :192
