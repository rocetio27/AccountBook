...
static void AccountBook_accessor_ccButton_textcolor__cctor__fn(uType* __type)
{
    ...
    AccountBook_accessor_ccButton_textcolor::_name_ = ::g::Uno::UX::Selector__op_Implicit1(::STRINGS[0/*"textcolor"*/]);
}
...
{
    uStackFrame __("AccountBook_accessor_ccButton_textcolor", "GetAsObject(Uno.UX.PropertyObject)");
...
{
    uStackFrame __("AccountBook_accessor_ccButton_textcolor", "SetAsObject(Uno.UX.PropertyObject,object,Uno.UX.IPropertyListener)");
