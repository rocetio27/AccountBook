...
static void AccountBook_accessor_dayButton_fontsize__cctor__fn(uType* __type)
{
    ...
    AccountBook_accessor_dayButton_fontsize::_name_ = ::g::Uno::UX::Selector__op_Implicit1(::STRINGS[0/*"fontsize"*/]);
}
...
{
    uStackFrame __("AccountBook_accessor_dayButton_fontsize", "GetAsObject(Uno.UX.PropertyObject)");
    return *__retval = uBox<int32_t>(::g::Uno::Int_typeof(), uPtr(uCast< ::g::dayButton*>(obj, ::TYPES[0/*dayButton*/]))->fontsize()), void();
}
...
{
    uStackFrame __("AccountBook_accessor_dayButton_fontsize", "SetAsObject(Uno.UX.PropertyObject,object,Uno.UX.IPropertyListener)");
    uPtr(uCast< ::g::dayButton*>(obj, ::TYPES[0/*dayButton*/]))->Setfontsize(uUnbox<int32_t>(::g::Uno::Int_typeof(), v), origin);
}
