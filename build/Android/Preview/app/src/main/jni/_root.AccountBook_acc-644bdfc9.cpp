...
static void AccountBook_accessor_ccButton_fontsize_build(uType* type)
{
    ...
    type->SetFields(0,
        ::g::Uno::UX::PropertyAccessor_typeof(), (uintptr_t)&AccountBook_accessor_ccButton_fontsize::Singleton_, uFieldFlagsStatic,
        ::g::Uno::UX::Selector_typeof(), (uintptr_t)&AccountBook_accessor_ccButton_fontsize::_name_, uFieldFlagsStatic);
}
...
::g::Uno::UX::PropertyAccessor_type* AccountBook_accessor_ccButton_fontsize_typeof()
{
    ...
    options.ObjectSize = sizeof(AccountBook_accessor_ccButton_fontsize);
    options.TypeSize = sizeof(::g::Uno::UX::PropertyAccessor_type);
    type = (::g::Uno::UX::PropertyAccessor_type*)uClassType::New("AccountBook_accessor_ccButton_fontsize", options);
    type->fp_build_ = AccountBook_accessor_ccButton_fontsize_build;
    type->fp_ctor_ = (void*)AccountBook_accessor_ccButton_fontsize__New1_fn;
    type->fp_cctor_ = AccountBook_accessor_ccButton_fontsize__cctor__fn;
    type->fp_GetAsObject = (void(*)(::g::Uno::UX::PropertyAccessor*, ::g::Uno::UX::PropertyObject*, uObject**))AccountBook_accessor_ccButton_fontsize__GetAsObject_fn;
    type->fp_get_Name = (void(*)(::g::Uno::UX::PropertyAccessor*, ::g::Uno::UX::Selector*))AccountBook_accessor_ccButton_fontsize__get_Name_fn;
    type->fp_get_PropertyType = (void(*)(::g::Uno::UX::PropertyAccessor*, uType**))AccountBook_accessor_ccButton_fontsize__get_PropertyType_fn;
    type->fp_SetAsObject = (void(*)(::g::Uno::UX::PropertyAccessor*, ::g::Uno::UX::PropertyObject*, uObject*, uObject*))AccountBook_accessor_ccButton_fontsize__SetAsObject_fn;
    type->fp_get_SupportsOriginSetter = (void(*)(::g::Uno::UX::PropertyAccessor*, bool*))AccountBook_accessor_ccButton_fontsize__get_SupportsOriginSetter_fn;
    return type;
}

// public generated AccountBook_accessor_ccButton_fontsize() :51
...
{
    uStackFrame __("AccountBook_accessor_ccButton_fontsize", "GetAsObject(Uno.UX.PropertyObject)");
...
{
    return *__retval = AccountBook_accessor_ccButton_fontsize::_name_, void();
}

// public generated AccountBook_accessor_ccButton_fontsize New() :51
void AccountBook_accessor_ccButton_fontsize__New1_fn(AccountBook_accessor_ccButton_fontsize** __retval)
{
    *__retval = AccountBook_accessor_ccButton_fontsize::New1();
}
...
{
    uStackFrame __("AccountBook_accessor_ccButton_fontsize", "SetAsObject(Uno.UX.PropertyObject,object,Uno.UX.IPropertyListener)");
...
uSStrong< ::g::Uno::UX::PropertyAccessor*> AccountBook_accessor_ccButton_fontsize::Singleton_;
::g::Uno::UX::Selector AccountBook_accessor_ccButton_fontsize::_name_;

// public generated AccountBook_accessor_ccButton_fontsize() [instance] :51
void AccountBook_accessor_ccButton_fontsize::ctor_1()
{
    ctor_();
}

// public generated AccountBook_accessor_ccButton_fontsize New() [static] :51
AccountBook_accessor_ccButton_fontsize* AccountBook_accessor_ccButton_fontsize::New1()
{
    AccountBook_accessor_ccButton_fontsize* obj1 = (AccountBook_accessor_ccButton_fontsize*)uNew(AccountBook_accessor_ccButton_fontsize_typeof());
    obj1->ctor_1();
    return obj1;
}
// }
