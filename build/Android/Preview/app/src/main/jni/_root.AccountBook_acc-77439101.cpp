...
// internal sealed class AccountBook_accessor_myButton_fontsize :141
// {
// static generated AccountBook_accessor_myButton_fontsize() :141
...
static void AccountBook_accessor_myButton_fontsize_build(uType* type)
{
    ...
    type->SetFields(0,
        ::g::Uno::UX::PropertyAccessor_typeof(), (uintptr_t)&AccountBook_accessor_myButton_fontsize::Singleton_, uFieldFlagsStatic,
        ::g::Uno::UX::Selector_typeof(), (uintptr_t)&AccountBook_accessor_myButton_fontsize::_name_, uFieldFlagsStatic);
}
...
::g::Uno::UX::PropertyAccessor_type* AccountBook_accessor_myButton_fontsize_typeof()
{
    ...
    options.ObjectSize = sizeof(AccountBook_accessor_myButton_fontsize);
    options.TypeSize = sizeof(::g::Uno::UX::PropertyAccessor_type);
    type = (::g::Uno::UX::PropertyAccessor_type*)uClassType::New("AccountBook_accessor_myButton_fontsize", options);
    type->fp_build_ = AccountBook_accessor_myButton_fontsize_build;
    type->fp_ctor_ = (void*)AccountBook_accessor_myButton_fontsize__New1_fn;
    type->fp_cctor_ = AccountBook_accessor_myButton_fontsize__cctor__fn;
    type->fp_GetAsObject = (void(*)(::g::Uno::UX::PropertyAccessor*, ::g::Uno::UX::PropertyObject*, uObject**))AccountBook_accessor_myButton_fontsize__GetAsObject_fn;
    type->fp_get_Name = (void(*)(::g::Uno::UX::PropertyAccessor*, ::g::Uno::UX::Selector*))AccountBook_accessor_myButton_fontsize__get_Name_fn;
    type->fp_get_PropertyType = (void(*)(::g::Uno::UX::PropertyAccessor*, uType**))AccountBook_accessor_myButton_fontsize__get_PropertyType_fn;
    type->fp_SetAsObject = (void(*)(::g::Uno::UX::PropertyAccessor*, ::g::Uno::UX::PropertyObject*, uObject*, uObject*))AccountBook_accessor_myButton_fontsize__SetAsObject_fn;
    type->fp_get_SupportsOriginSetter = (void(*)(::g::Uno::UX::PropertyAccessor*, bool*))AccountBook_accessor_myButton_fontsize__get_SupportsOriginSetter_fn;
    return type;
}

// public generated AccountBook_accessor_myButton_fontsize() :141
...
{
    uStackFrame __("AccountBook_accessor_myButton_fontsize", "GetAsObject(Uno.UX.PropertyObject)");
...
// public generated AccountBook_accessor_myButton_fontsize New() :141
...
{
    uStackFrame __("AccountBook_accessor_myButton_fontsize", "SetAsObject(Uno.UX.PropertyObject,object,Uno.UX.IPropertyListener)");
...
// public generated AccountBook_accessor_myButton_fontsize() [instance] :141
void AccountBook_accessor_myButton_fontsize::ctor_1()
{
    ctor_();
}

// public generated AccountBook_accessor_myButton_fontsize New() [static] :141
