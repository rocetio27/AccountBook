...
{
    uStackFrame __("AccountBook_accessor_dayButton_textcolor", "GetAsObject(Uno.UX.PropertyObject)");
...
{
    uStackFrame __("AccountBook_accessor_dayButton_textcolor", "SetAsObject(Uno.UX.PropertyObject,object,Uno.UX.IPropertyListener)");
