...
static void AccountBook_accessor_dayButton_text__cctor__fn(uType* __type)
{
    ...
    AccountBook_accessor_dayButton_text::_name_ = ::g::Uno::UX::Selector__op_Implicit1(::STRINGS[0/*"text"*/]);
}
...
{
    uStackFrame __("AccountBook_accessor_dayButton_text", "GetAsObject(Uno.UX.PropertyObject)");
...
{
    uStackFrame __("AccountBook_accessor_dayButton_text", "SetAsObject(Uno.UX.PropertyObject,object,Uno.UX.IPropertyListener)");
