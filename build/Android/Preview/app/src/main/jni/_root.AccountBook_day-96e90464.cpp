...
// internal sealed class AccountBook_dayButton_text_Property :351
// {
static void AccountBook_dayButton_text_Property_build(uType* type)
{
    ...
    type->SetFields(1,
        ::TYPES[0/*dayButton*/], offsetof(AccountBook_dayButton_text_Property, _obj), uFieldFlagsWeak);
}

::g::Uno::UX::Property1_type* AccountBook_dayButton_text_Property_typeof()
{
    ...
    options.ObjectSize = sizeof(AccountBook_dayButton_text_Property);
    options.TypeSize = sizeof(::g::Uno::UX::Property1_type);
    type = (::g::Uno::UX::Property1_type*)uClassType::New("AccountBook_dayButton_text_Property", options);
    type->fp_build_ = AccountBook_dayButton_text_Property_build;
    type->fp_Get1 = (void(*)(::g::Uno::UX::Property1*, ::g::Uno::UX::PropertyObject*, uTRef))AccountBook_dayButton_text_Property__Get1_fn;
    type->fp_get_Object = (void(*)(::g::Uno::UX::Property*, ::g::Uno::UX::PropertyObject**))AccountBook_dayButton_text_Property__get_Object_fn;
    type->fp_Set1 = (void(*)(::g::Uno::UX::Property1*, ::g::Uno::UX::PropertyObject*, void*, uObject*))AccountBook_dayButton_text_Property__Set1_fn;
    type->fp_get_SupportsOriginSetter = (void(*)(::g::Uno::UX::PropertyAccessor*, bool*))AccountBook_dayButton_text_Property__get_SupportsOriginSetter_fn;
    return type;
}

// public AccountBook_dayButton_text_Property(dayButton obj, Uno.UX.Selector name) :354
...
{
    uStackFrame __("AccountBook_dayButton_text_Property", "Get(Uno.UX.PropertyObject)");
    return *__retval = uPtr(uCast< ::g::dayButton*>(obj, ::TYPES[0/*dayButton*/]))->text(), void();
}

// public AccountBook_dayButton_text_Property New(dayButton obj, Uno.UX.Selector name) :354
...
{
    uStackFrame __("AccountBook_dayButton_text_Property", "Set(Uno.UX.PropertyObject,string,Uno.UX.IPropertyListener)");
...
// public AccountBook_dayButton_text_Property(dayButton obj, Uno.UX.Selector name) [instance] :354
...
// public AccountBook_dayButton_text_Property New(dayButton obj, Uno.UX.Selector name) [static] :354
