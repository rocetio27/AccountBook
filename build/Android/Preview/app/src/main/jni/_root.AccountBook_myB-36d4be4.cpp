...
// internal sealed class AccountBook_myButton_text_Property :274
// {
...
// public AccountBook_myButton_text_Property(myButton obj, Uno.UX.Selector name) :277
...
// public override sealed string Get(Uno.UX.PropertyObject obj) :279
...
{
    uStackFrame __("AccountBook_myButton_text_Property", "Get(Uno.UX.PropertyObject)");
    return *__retval = uPtr(uCast< ::g::myButton*>(obj, ::TYPES[0/*myButton*/]))->text(), void();
}

// public AccountBook_myButton_text_Property New(myButton obj, Uno.UX.Selector name) :277
...
// public override sealed void Set(Uno.UX.PropertyObject obj, string v, Uno.UX.IPropertyListener origin) :280
...
{
    uStackFrame __("AccountBook_myButton_text_Property", "Set(Uno.UX.PropertyObject,string,Uno.UX.IPropertyListener)");
...
// public AccountBook_myButton_text_Property(myButton obj, Uno.UX.Selector name) [instance] :277
...
// public AccountBook_myButton_text_Property New(myButton obj, Uno.UX.Selector name) [static] :277
