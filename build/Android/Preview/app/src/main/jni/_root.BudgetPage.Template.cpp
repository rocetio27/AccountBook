...
static void BudgetPage__Template_build(uType* type)
{
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)BudgetPage__Template__New2_fn, 0, true, type, 2, ::g::BudgetPage_typeof(), ::g::BudgetPage_typeof()));
}
...
{
    uStackFrame __("BudgetPage.Template", "New()");
