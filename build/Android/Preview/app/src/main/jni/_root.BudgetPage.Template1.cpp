...
// public partial sealed class BudgetPage.Template1 :44
// {
// static Template1() :55
static void BudgetPage__Template1__cctor__fn(uType* __type)
{
    BudgetPage__Template1::__selector0_ = ::g::Uno::UX::Selector__op_Implicit1(::STRINGS[0/*"Value"*/]);
}
...
static void BudgetPage__Template1_build(uType* type)
{
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)BudgetPage__Template1__New2_fn, 0, true, type, 2, ::g::BudgetPage_typeof(), ::g::BudgetPage_typeof()));
}
...
// public Template1(BudgetPage parent, BudgetPage parentInstance) :48
...
{
    uStackFrame __("BudgetPage.Template1", "New()");
...
// public Template1 New(BudgetPage parent, BudgetPage parentInstance) :48
...
// public Template1(BudgetPage parent, BudgetPage parentInstance) [instance] :48
...
// public Template1 New(BudgetPage parent, BudgetPage parentInstance) [static] :48
