...
// {
// static Template2() :103
static void BudgetPage__Template2__cctor__fn(uType* __type)
{
    BudgetPage__Template2::__selector0_ = ::g::Uno::UX::Selector__op_Implicit1(::STRINGS[0/*"Text"*/]);
}
...
static void BudgetPage__Template2_build(uType* type)
{
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)BudgetPage__Template2__New2_fn, 0, true, type, 2, ::g::BudgetPage_typeof(), ::g::BudgetPage_typeof()));
}
...
// public Template2(BudgetPage parent, BudgetPage parentInstance) :96
...
{
    uStackFrame __("BudgetPage.Template2", "New()");
...
// public Template2 New(BudgetPage parent, BudgetPage parentInstance) :96
...
// public Template2(BudgetPage parent, BudgetPage parentInstance) [instance] :96
...
// public Template2 New(BudgetPage parent, BudgetPage parentInstance) [static] :96
