...
static void BudgetPage_build(uType* type)
{
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)BudgetPage__New4_fn, 0, true, type, 1, ::g::Fuse::Navigation::Router_typeof()));
}
...
// public BudgetPage(Fuse.Navigation.Router router) [instance] :312
void BudgetPage::ctor_7(::g::Fuse::Navigation::Router* router1)
{
    uStackFrame __("BudgetPage", ".ctor(Fuse.Navigation.Router)");
    ctor_6();
    router = router1;
    InitializeUX();
}

// private void InitializeUX() [instance] :318
void BudgetPage::InitializeUX()
{
    uStackFrame __("BudgetPage", "InitializeUX()");
    ...
    uPtr(ModalConfirm)->SourceLineNumber(142);
    ...
    uPtr(calendar_lbutton)->SourceLineNumber(150);
    ...
    uPtr(calendar_rbutton)->SourceLineNumber(158);
...
// public BudgetPage New(Fuse.Navigation.Router router) [static] :312
