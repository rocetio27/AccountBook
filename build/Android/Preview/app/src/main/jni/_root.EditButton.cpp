// This file was generated based on C:/Users/SpaceJockey27/Documents/Fuse/AccountBook/build/Android/Preview/cache/ux15/EditButton.g.uno.
...
{
    EditButton::__selector0_ = ::g::Uno::UX::Selector__op_Implicit1(::STRINGS[0/*"Color"*/]);
    EditButton::__selector1_ = ::g::Uno::UX::Selector__op_Implicit1(::STRINGS[1/*"Value"*/]);
    EditButton::__selector2_ = ::g::Uno::UX::Selector__op_Implicit1(::STRINGS[2/*"FontSize"*/]);
    EditButton::__selector3_ = ::g::Uno::UX::Selector__op_Implicit1(::STRINGS[3/*"back"*/]);
}
...
static void EditButton_build(uType* type)
{
    ...
    type->Reflection.SetFunctions(10,
        new uFunction("get_fontsize", NULL, (void*)EditButton__get_fontsize_fn, 0, false, ::g::Uno::Int_typeof(), 0),
        new uFunction("set_fontsize", NULL, (void*)EditButton__set_fontsize_fn, 0, false, uVoid_typeof(), 1, ::g::Uno::Int_typeof()),
        new uFunction(".ctor", NULL, (void*)EditButton__New6_fn, 0, true, type, 0),
        new uFunction("Setfontsize", NULL, (void*)EditButton__Setfontsize_fn, 0, false, uVoid_typeof(), 2, ::g::Uno::Int_typeof(), ::g::Uno::UX::IPropertyListener_typeof()),
        new uFunction("Settext", NULL, (void*)EditButton__Settext_fn, 0, false, uVoid_typeof(), 2, ::g::Uno::String_typeof(), ::g::Uno::UX::IPropertyListener_typeof()),
        new uFunction("Settextcolor", NULL, (void*)EditButton__Settextcolor_fn, 0, false, uVoid_typeof(), 2, ::g::Uno::Float4_typeof(), ::g::Uno::UX::IPropertyListener_typeof()),
        new uFunction("get_text", NULL, (void*)EditButton__get_text_fn, 0, false, ::g::Uno::String_typeof(), 0),
        new uFunction("set_text", NULL, (void*)EditButton__set_text_fn, 0, false, uVoid_typeof(), 1, ::g::Uno::String_typeof()),
        new uFunction("get_textcolor", NULL, (void*)EditButton__get_textcolor_fn, 0, false, ::g::Uno::Float4_typeof(), 0),
        new uFunction("set_textcolor", NULL, (void*)EditButton__set_textcolor_fn, 0, false, uVoid_typeof(), 1, ::g::Uno::Float4_typeof()));
}
...
void EditButton__get_fontsize_fn(EditButton* __this, int32_t* __retval)
{
    *__retval = __this->fontsize();
}

// public void set_fontsize(int value) :39
void EditButton__set_fontsize_fn(EditButton* __this, int32_t* value)
{
...
void EditButton__Setfontsize_fn(EditButton* __this, int32_t* value, uObject* origin)
{
...
{
    uStackFrame __("EditButton", ".ctor()");
    ctor_8();
    InitializeUX1();
}

// public int get_fontsize() [instance] :38
int32_t EditButton::fontsize()
{
    return _field_fontsize;
}

// public void set_fontsize(int value) [instance] :39
void EditButton::fontsize(int32_t value)
{
    uStackFrame __("EditButton", "set_fontsize(int)");
...
{
    uStackFrame __("EditButton", "InitializeUX()");
    ...
    ::g::Fuse::Reactive::Property* temp2 = ::g::Fuse::Reactive::Property::New1(temp1, ::g::AccountBook_accessor_EditButton_text::Singleton());
    ...
    ::g::Fuse::Reactive::Property* temp4 = ::g::Fuse::Reactive::Property::New1(temp3, ::g::AccountBook_accessor_EditButton_textcolor::Singleton());
    ...
    ::g::Fuse::Reactive::Property* temp6 = ::g::Fuse::Reactive::Property::New1(temp5, ::g::AccountBook_accessor_EditButton_fontsize::Singleton());
    ...
    SourceLineNumber(155);
    SourceFileName(::STRINGS[4/*"ListPage.ux"*/]);
    temp7->SourceLineNumber(156);
    temp7->SourceFileName(::STRINGS[4/*"ListPage.ux"*/]);
    ...
    temp9->SourceFileName(::STRINGS[4/*"ListPage.ux"*/]);
    ...
    uPtr(back)->Color(::g::Fuse::Drawing::Colors::White());
    uPtr(back)->Layer(1);
    uPtr(back)->Name(EditButton::__selector3_);
    uPtr(back)->SourceLineNumber(163);
    uPtr(back)->SourceFileName(::STRINGS[4/*"ListPage.ux"*/]);
...
void EditButton::Setfontsize(int32_t value, uObject* origin)
{
    uStackFrame __("EditButton", "Setfontsize(int,Uno.UX.IPropertyListener)");
...
{
    uStackFrame __("EditButton", "Settext(string,Uno.UX.IPropertyListener)");
...
{
    uStackFrame __("EditButton", "Settextcolor(float4,Uno.UX.IPropertyListener)");

    if (::g::Uno::Float4__op_Inequality(value, _field_textcolor))
    {
        _field_textcolor = value;
        OnPropertyChanged1(::g::Uno::UX::Selector__op_Implicit1(::STRINGS[7/*"textcolor"*/]), origin);
    }
}
...
{
    uStackFrame __("EditButton", "set_text(string)");
    Settext(value, NULL);
}
...
{
    uStackFrame __("EditButton", "set_textcolor(float4)");
