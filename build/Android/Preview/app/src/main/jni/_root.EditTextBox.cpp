// This file was generated based on C:/Users/SpaceJockey27/Documents/Fuse/AccountBook/build/Android/Preview/cache/ux15/EditTextBox.g.uno.
...
static void EditTextBox_build(uType* type)
{
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)EditTextBox__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextInput_type* EditTextBox_typeof()
{
    ...
    type = (::g::Fuse::Controls::TextInput_type*)uClassType::New("EditTextBox", options);
...
{
    uStackFrame __("EditTextBox", ".ctor()");
    ctor_7();
    InitializeUX();
}
...
{
    uStackFrame __("EditTextBox", "InitializeUX()");
