...
static void SQLite_build(uType* type)
{
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)SQLite__New2_fn, 0, true, type, 0));
}
...
{
    uStackFrame __("SQLite", "Open(Fuse.Scripting.Context,object[])");
...
{
    uStackFrame __("SQLite", "OpenFromBundle(Fuse.Scripting.Context,object[])");
