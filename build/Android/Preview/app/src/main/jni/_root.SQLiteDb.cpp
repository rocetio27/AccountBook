...
static void SQLiteDb_build(uType* type)
{
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)SQLiteDb__New2_fn, 0, true, type, 1, ::TYPES[1/*string*/]));
}
...
{
    uStackFrame __("SQLiteDb", ".ctor(string)");
    ctor_1();
    filename = filename1;
...
{
    uStackFrame __("SQLiteDb", "Execute(Fuse.Scripting.Context,object[])");
...
{
    uStackFrame __("SQLiteDb", "Prepare(Fuse.Scripting.Context,object[])");
    uString* statement = uAs<uString*>(uPtr(args)->Strong<uObject*>(0), ::TYPES[1/*string*/]);
...
{
    uStackFrame __("SQLiteDb", "Query(Fuse.Scripting.Context,object[])");
    uString* statement = uAs<uString*>(uPtr(args)->Strong<uObject*>(0), ::TYPES[1/*string*/]);
    int32_t param_len = args->Length() - 1;
    uArray* param = uArray::New(::TYPES[2/*string[]*/], param_len);
