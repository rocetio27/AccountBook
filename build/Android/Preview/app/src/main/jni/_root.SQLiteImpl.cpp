...
static void SQLiteImpl_build(uType* type)
{
    type->Reflection.SetFunctions(4,
        new uFunction("CloseImpl", NULL, (void*)SQLiteImpl__CloseImpl_fn, 0, true, uVoid_typeof(), 1, ::g::Java::Object_typeof()),
        new uFunction("ExecImpl", NULL, (void*)SQLiteImpl__ExecImpl_fn, 0, true, uVoid_typeof(), 3, ::g::Java::Object_typeof(), ::g::Uno::String_typeof(), ::g::Uno::String_typeof()->Array()),
        new uFunction("OpenImpl", NULL, (void*)SQLiteImpl__OpenImpl_fn, 0, true, ::g::Java::Object_typeof(), 1, ::g::Uno::String_typeof()),
        new uFunction("QueryImpl", NULL, (void*)SQLiteImpl__QueryImpl_fn, 0, true, uVoid_typeof(), 4, ::g::Bolav::ForeignHelpers::ForeignList_typeof(), ::g::Java::Object_typeof(), ::g::Uno::String_typeof(), ::g::Uno::String_typeof()->Array()));
}
...
{
    {
        ...
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "CloseImpl397", "(Ljava/lang/Object;)V");
...
{
    {
        INIT_JNI;
        jclass __cls = JniHelper::GetNativeExternClass();
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "ExecImpl398", "(Ljava/lang/Object;Ljava/lang/String;Lcom/uno/StringArray;)V");
        ::g::Java::Object* _udb=db;
        jobject _db = (_udb==NULL ? NULL : U_JNIVAR->NewLocalRef(::g::Android::Base::Wrappers::IJWrapper::_GetJavaObject(uInterface((uObject*)_udb, ::g::Android::Base::Wrappers::IJWrapper_typeof()))));
...
{
    {
        INIT_JNI;
        jclass __cls = JniHelper::GetNativeExternClass();
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "OpenImpl399", "(Ljava/lang/String;)Ljava/lang/Object;");
...
{
    {
        INIT_JNI;
        jclass __cls = JniHelper::GetNativeExternClass();
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "QueryImpl400", "(Lcom/uno/UnoObject;Ljava/lang/Object;Ljava/lang/String;Lcom/uno/StringArray;)V");
