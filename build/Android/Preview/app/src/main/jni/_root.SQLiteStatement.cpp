...
static void SQLiteStatement_build(uType* type)
{
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)SQLiteStatement__New2_fn, 0, true, type, 2, ::g::Java::Object_typeof(), ::TYPES[2/*string*/]));
}
...
{
    uStackFrame __("SQLiteStatement", ".ctor(string)");
    ctor_1();
...
{
    uStackFrame __("SQLiteStatement", "Execute(Fuse.Scripting.Context,object[])");
