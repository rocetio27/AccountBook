...
static void StatisticPage__Template_build(uType* type)
{
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)StatisticPage__Template__New2_fn, 0, true, type, 2, ::g::StatisticPage_typeof(), ::g::StatisticPage_typeof()));
}
...
// public Template(StatisticPage parent, StatisticPage parentInstance) :10
...
{
    uStackFrame __("StatisticPage.Template", "New()");
...
// public Template New(StatisticPage parent, StatisticPage parentInstance) :10
...
// public Template(StatisticPage parent, StatisticPage parentInstance) [instance] :10
...
// public Template New(StatisticPage parent, StatisticPage parentInstance) [static] :10
