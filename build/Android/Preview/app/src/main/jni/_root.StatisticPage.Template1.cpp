...
// public partial sealed class StatisticPage.Template1 :36
// {
// static Template1() :47
...
static void StatisticPage__Template1_build(uType* type)
{
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)StatisticPage__Template1__New2_fn, 0, true, type, 2, ::g::StatisticPage_typeof(), ::g::StatisticPage_typeof()));
}
...
// public Template1(StatisticPage parent, StatisticPage parentInstance) :40
...
{
    uStackFrame __("StatisticPage.Template1", "New()");
    ...
    temp->SourceLineNumber(125);
    temp->SourceFileName(::STRINGS[3/*"StatisticPa...*/]);
    temp1->SourceLineNumber(125);
...
// public Template1 New(StatisticPage parent, StatisticPage parentInstance) :40
...
// public Template1(StatisticPage parent, StatisticPage parentInstance) [instance] :40
...
// public Template1 New(StatisticPage parent, StatisticPage parentInstance) [static] :40
