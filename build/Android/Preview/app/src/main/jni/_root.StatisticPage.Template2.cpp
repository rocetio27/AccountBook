...
static void StatisticPage__Template2_build(uType* type)
{
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)StatisticPage__Template2__New2_fn, 0, true, type, 2, ::g::StatisticPage_typeof(), ::g::StatisticPage_typeof()));
}
...
// public Template2(StatisticPage parent, StatisticPage parentInstance) :87
...
void StatisticPage__Template2__New1_fn(StatisticPage__Template2* __this, uObject** __retval)
{
    ...
    __self1->SourceLineNumber(155);
    __self1->SourceFileName(::STRINGS[3/*"StatisticPa...*/]);
    temp->SourceLineNumber(156);
...
// public Template2 New(StatisticPage parent, StatisticPage parentInstance) :87
...
// public Template2(StatisticPage parent, StatisticPage parentInstance) [instance] :87
...
// public Template2 New(StatisticPage parent, StatisticPage parentInstance) [static] :87
