...
static void StatisticPage_build(uType* type)
{
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)StatisticPage__New4_fn, 0, true, type, 1, ::g::Fuse::Navigation::Router_typeof()));
}
...
// public StatisticPage(Fuse.Navigation.Router router) [instance] :199
void StatisticPage::ctor_7(::g::Fuse::Navigation::Router* router1)
{
    uStackFrame __("StatisticPage", ".ctor(Fuse.Navigation.Router)");
    ctor_6();
    router = router1;
    InitializeUX();
}

// private void InitializeUX() [instance] :205
void StatisticPage::InitializeUX()
{
    uStackFrame __("StatisticPage", "InitializeUX()");
    ...
    uPtr(FullWindo2)->SourceLineNumber(4);
    ...
    temp89->SourceLineNumber(65);
    temp89->SourceFileName(uString::Const("StatisticPage.ux"));
    temp31->SourceLineNumber(63);
    ...
    temp99->SourceLineNumber(79);
    temp99->SourceFileName(uString::Const("StatisticPage.ux"));
    temp100->SourceLineNumber(80);
    ...
    uPtr(ModalConfirm)->SourceLineNumber(97);
    ...
    uPtr(calendar_lbutton)->SourceLineNumber(105);
    ...
    uPtr(calendar_rbutton)->SourceLineNumber(113);
    ...
    temp123->SourceLineNumber(117);
    temp123->SourceFileName(uString::Const("StatisticPage.ux"));
    temp41->SourceLineNumber(112);
    ...
    temp42->SourceLineNumber(121);
    temp42->SourceFileName(uString::Const("StatisticPage.ux"));
    temp15->SourceLineNumber(124);
    ...
    temp43->SourceLineNumber(124);
    temp43->SourceFileName(uString::Const("StatisticPage.ux"));
    temp129->SourceLineNumber(132);
    ...
    temp16->Width(2.0f);
    temp44->SourceLineNumber(135);
    temp44->SourceFileName(uString::Const("StatisticPage.ux"));
    temp133->SourceLineNumber(137);
    ...
    temp134->SourceLineNumber(138);
    temp134->SourceFileName(uString::Const("StatisticPage.ux"));
    temp135->SourceLineNumber(139);
    ...
    temp45->SourceLineNumber(132);
    temp45->SourceFileName(uString::Const("StatisticPage.ux"));
    temp46->SourceLineNumber(97);
    ...
    uPtr(ModalConfirm2)->SourceLineNumber(145);
    ...
    temp48->SourceLineNumber(153);
    temp48->SourceFileName(uString::Const("StatisticPage.ux"));
    temp19->SourceLineNumber(154);
    ...
    temp20->Width(2.0f);
    temp52->SourceLineNumber(168);
    temp52->SourceFileName(uString::Const("StatisticPage.ux"));
    temp152->SourceLineNumber(170);
    ...
    temp153->SourceLineNumber(171);
    temp153->SourceFileName(uString::Const("StatisticPage.ux"));
    temp154->SourceLineNumber(172);
    ...
    temp53->SourceLineNumber(165);
    temp53->SourceFileName(uString::Const("StatisticPage.ux"));
    temp54->SourceLineNumber(145);
...
// public StatisticPage New(Fuse.Navigation.Router router) [static] :199
