// This file was generated based on C:/Users/SpaceJockey27/Documents/Fuse/AccountBook/build/Android/Preview/cache/ux15/ccButton.g.uno.
...
{
    ccButton::__selector0_ = ::g::Uno::UX::Selector__op_Implicit1(::STRINGS[0/*"FontSize"*/]);
    ccButton::__selector1_ = ::g::Uno::UX::Selector__op_Implicit1(::STRINGS[1/*"Color"*/]);
    ccButton::__selector2_ = ::g::Uno::UX::Selector__op_Implicit1(::STRINGS[2/*"Value"*/]);
    ccButton::__selector3_ = ::g::Uno::UX::Selector__op_Implicit1(::STRINGS[3/*"textcolor"*/]);
}
...
static void ccButton_build(uType* type)
{
    ...
    type->Reflection.SetFunctions(10,
        new uFunction("get_fontsize", NULL, (void*)ccButton__get_fontsize_fn, 0, false, ::g::Uno::Int_typeof(), 0),
        new uFunction("set_fontsize", NULL, (void*)ccButton__set_fontsize_fn, 0, false, uVoid_typeof(), 1, ::g::Uno::Int_typeof()),
        new uFunction(".ctor", NULL, (void*)ccButton__New6_fn, 0, true, type, 0),
        new uFunction("Setfontsize", NULL, (void*)ccButton__Setfontsize_fn, 0, false, uVoid_typeof(), 2, ::g::Uno::Int_typeof(), ::g::Uno::UX::IPropertyListener_typeof()),
        new uFunction("Settext", NULL, (void*)ccButton__Settext_fn, 0, false, uVoid_typeof(), 2, ::g::Uno::String_typeof(), ::g::Uno::UX::IPropertyListener_typeof()),
        new uFunction("Settextcolor", NULL, (void*)ccButton__Settextcolor_fn, 0, false, uVoid_typeof(), 2, ::g::Uno::Float4_typeof(), ::g::Uno::UX::IPropertyListener_typeof()),
        new uFunction("get_text", NULL, (void*)ccButton__get_text_fn, 0, false, ::g::Uno::String_typeof(), 0),
        new uFunction("set_text", NULL, (void*)ccButton__set_text_fn, 0, false, uVoid_typeof(), 1, ::g::Uno::String_typeof()),
        new uFunction("get_textcolor", NULL, (void*)ccButton__get_textcolor_fn, 0, false, ::g::Uno::Float4_typeof(), 0),
        new uFunction("set_textcolor", NULL, (void*)ccButton__set_textcolor_fn, 0, false, uVoid_typeof(), 1, ::g::Uno::Float4_typeof()));
}
...
{
    uStackFrame __("ccButton", ".ctor()");
    ctor_8();
    InitializeUX1();
}

// public int get_fontsize() [instance] :38
int32_t ccButton::fontsize()
{
    return _field_fontsize;
}

// public void set_fontsize(int value) [instance] :39
void ccButton::fontsize(int32_t value)
{
    uStackFrame __("ccButton", "set_fontsize(int)");
...
{
    uStackFrame __("ccButton", "InitializeUX()");
    ...
    ::g::Fuse::Reactive::Property* temp2 = ::g::Fuse::Reactive::Property::New1(temp1, ::g::AccountBook_accessor_ccButton_fontsize::Singleton());
    ...
    ::g::Fuse::Reactive::Property* temp4 = ::g::Fuse::Reactive::Property::New1(temp3, ::g::AccountBook_accessor_ccButton_textcolor::Singleton());
    ...
    ::g::Fuse::Reactive::Property* temp6 = ::g::Fuse::Reactive::Property::New1(temp5, ::g::AccountBook_accessor_ccButton_text::Singleton());
...
void ccButton::Setfontsize(int32_t value, uObject* origin)
{
    uStackFrame __("ccButton", "Setfontsize(int,Uno.UX.IPropertyListener)");
...
{
    uStackFrame __("ccButton", "Settext(string,Uno.UX.IPropertyListener)");
...
{
    uStackFrame __("ccButton", "Settextcolor(float4,Uno.UX.IPropertyListener)");
...
{
    uStackFrame __("ccButton", "set_text(string)");
    Settext(value, NULL);
}
...
{
    uStackFrame __("ccButton", "set_textcolor(float4)");
