...
static void dayButton_build(uType* type)
{
    ...
    type->Reflection.SetFunctions(10,
        new uFunction("get_fontsize", NULL, (void*)dayButton__get_fontsize_fn, 0, false, ::g::Uno::Int_typeof(), 0),
        new uFunction("set_fontsize", NULL, (void*)dayButton__set_fontsize_fn, 0, false, uVoid_typeof(), 1, ::g::Uno::Int_typeof()),
        new uFunction(".ctor", NULL, (void*)dayButton__New6_fn, 0, true, type, 0),
        new uFunction("Setfontsize", NULL, (void*)dayButton__Setfontsize_fn, 0, false, uVoid_typeof(), 2, ::g::Uno::Int_typeof(), ::g::Uno::UX::IPropertyListener_typeof()),
        new uFunction("Settext", NULL, (void*)dayButton__Settext_fn, 0, false, uVoid_typeof(), 2, ::g::Uno::String_typeof(), ::g::Uno::UX::IPropertyListener_typeof()),
        new uFunction("Settextcolor", NULL, (void*)dayButton__Settextcolor_fn, 0, false, uVoid_typeof(), 2, ::g::Uno::Float4_typeof(), ::g::Uno::UX::IPropertyListener_typeof()),
        new uFunction("get_text", NULL, (void*)dayButton__get_text_fn, 0, false, ::g::Uno::String_typeof(), 0),
        new uFunction("set_text", NULL, (void*)dayButton__set_text_fn, 0, false, uVoid_typeof(), 1, ::g::Uno::String_typeof()),
        new uFunction("get_textcolor", NULL, (void*)dayButton__get_textcolor_fn, 0, false, ::g::Uno::Float4_typeof(), 0),
        new uFunction("set_textcolor", NULL, (void*)dayButton__set_textcolor_fn, 0, false, uVoid_typeof(), 1, ::g::Uno::Float4_typeof()));
}
...
{
    uStackFrame __("dayButton", "set_fontsize(int)");
...
{
    uStackFrame __("dayButton", "InitializeUX()");
...
{
    uStackFrame __("dayButton", "Setfontsize(int,Uno.UX.IPropertyListener)");
...
{
    uStackFrame __("dayButton", "Settext(string,Uno.UX.IPropertyListener)");
...
{
    uStackFrame __("dayButton", "Settextcolor(float4,Uno.UX.IPropertyListener)");
...
{
    uStackFrame __("dayButton", "set_text(string)");
    Settext(value, NULL);
}
...
{
    uStackFrame __("dayButton", "set_textcolor(float4)");
