// This file was generated based on C:/Users/SpaceJockey27/Documents/Fuse/AccountBook/build/Android/Preview/cache/ux15/myButton.g.uno.
...
{
    myButton::__selector0_ = ::g::Uno::UX::Selector__op_Implicit1(::STRINGS[0/*"Font"*/]);
    myButton::__selector1_ = ::g::Uno::UX::Selector__op_Implicit1(::STRINGS[1/*"FontSize"*/]);
    myButton::__selector2_ = ::g::Uno::UX::Selector__op_Implicit1(::STRINGS[2/*"Color"*/]);
    myButton::__selector3_ = ::g::Uno::UX::Selector__op_Implicit1(::STRINGS[3/*"Value"*/]);
    myButton::__selector4_ = ::g::Uno::UX::Selector__op_Implicit1(::STRINGS[4/*"textcolor"*/]);
}
...
static void myButton_build(uType* type)
{
    ...
    ::STRINGS[5] = uString::Const("StatisticPage.ux");
    ::STRINGS[6] = uString::Const("font");
    ...
    type->Reflection.SetFunctions(13,
        new uFunction("get_font", NULL, (void*)myButton__get_font_fn, 0, false, ::g::Fuse::Font_typeof(), 0),
        new uFunction("set_font", NULL, (void*)myButton__set_font_fn, 0, false, uVoid_typeof(), 1, ::g::Fuse::Font_typeof()),
        new uFunction("get_fontsize", NULL, (void*)myButton__get_fontsize_fn, 0, false, ::g::Uno::Int_typeof(), 0),
        new uFunction("set_fontsize", NULL, (void*)myButton__set_fontsize_fn, 0, false, uVoid_typeof(), 1, ::g::Uno::Int_typeof()),
        new uFunction(".ctor", NULL, (void*)myButton__New6_fn, 0, true, type, 0),
        new uFunction("Setfont", NULL, (void*)myButton__Setfont_fn, 0, false, uVoid_typeof(), 2, ::g::Fuse::Font_typeof(), ::g::Uno::UX::IPropertyListener_typeof()),
        new uFunction("Setfontsize", NULL, (void*)myButton__Setfontsize_fn, 0, false, uVoid_typeof(), 2, ::g::Uno::Int_typeof(), ::g::Uno::UX::IPropertyListener_typeof()),
        new uFunction("Settext", NULL, (void*)myButton__Settext_fn, 0, false, uVoid_typeof(), 2, ::g::Uno::String_typeof(), ::g::Uno::UX::IPropertyListener_typeof()),
        new uFunction("Settextcolor", NULL, (void*)myButton__Settextcolor_fn, 0, false, uVoid_typeof(), 2, ::g::Uno::Float4_typeof(), ::g::Uno::UX::IPropertyListener_typeof()),
        new uFunction("get_text", NULL, (void*)myButton__get_text_fn, 0, false, ::g::Uno::String_typeof(), 0),
        new uFunction("set_text", NULL, (void*)myButton__set_text_fn, 0, false, uVoid_typeof(), 1, ::g::Uno::String_typeof()),
        new uFunction("get_textcolor", NULL, (void*)myButton__get_textcolor_fn, 0, false, ::g::Uno::Float4_typeof(), 0),
        new uFunction("set_textcolor", NULL, (void*)myButton__set_textcolor_fn, 0, false, uVoid_typeof(), 1, ::g::Uno::Float4_typeof()));
}
...
{
    uStackFrame __("myButton", "set_font(Fuse.Font)");
    Setfont(value, NULL);
}

// public int get_fontsize() [instance] :53
int32_t myButton::fontsize()
{
    return _field_fontsize;
}

// public void set_fontsize(int value) [instance] :54
void myButton::fontsize(int32_t value)
{
    uStackFrame __("myButton", "set_fontsize(int)");
...
void myButton::InitializeUX1()
{
    ...
    ::g::Fuse::Reactive::Property* temp2 = ::g::Fuse::Reactive::Property::New1(temp1, ::g::AccountBook_accessor_myButton_font::Singleton());
    ...
    ::g::Fuse::Reactive::Property* temp4 = ::g::Fuse::Reactive::Property::New1(temp3, ::g::AccountBook_accessor_myButton_fontsize::Singleton());
    ...
    ::g::Fuse::Reactive::Property* temp6 = ::g::Fuse::Reactive::Property::New1(temp5, ::g::AccountBook_accessor_myButton_textcolor::Singleton());
    ...
    ::g::Fuse::Reactive::Property* temp8 = ::g::Fuse::Reactive::Property::New1(temp7, ::g::AccountBook_accessor_myButton_text::Singleton());
    ...
    SourceLineNumber(6);
    SourceFileName(::STRINGS[5/*"StatisticPa...*/]);
    temp->Alignment(10);
    temp->SourceLineNumber(11);
    temp->SourceFileName(::STRINGS[5/*"StatisticPa...*/]);
    ...
    temp2->SourceFileName(::STRINGS[5/*"StatisticPa...*/]);
    temp1->SourceLineNumber(11);
    temp1->SourceFileName(::STRINGS[5/*"StatisticPa...*/]);
    temp4->SourceLineNumber(11);
    temp4->SourceFileName(::STRINGS[5/*"StatisticPa...*/]);
    temp3->SourceLineNumber(11);
    temp3->SourceFileName(::STRINGS[5/*"StatisticPa...*/]);
    temp6->SourceLineNumber(11);
    temp6->SourceFileName(::STRINGS[5/*"StatisticPa...*/]);
    temp5->SourceLineNumber(11);
    temp5->SourceFileName(::STRINGS[5/*"StatisticPa...*/]);
    temp8->SourceLineNumber(11);
    temp8->SourceFileName(::STRINGS[5/*"StatisticPa...*/]);
    temp7->SourceLineNumber(11);
    temp7->SourceFileName(::STRINGS[5/*"StatisticPa...*/]);
    temp13->SourceLineNumber(12);
    temp13->SourceFileName(::STRINGS[5/*"StatisticPa...*/]);
    ...
    temp15->SourceFileName(::STRINGS[5/*"StatisticPa...*/]);
    ...
    temp16->SourceFileName(::STRINGS[5/*"StatisticPa...*/]);
...
{
    uStackFrame __("myButton", "Setfont(Fuse.Font,Uno.UX.IPropertyListener)");

    if (value != _field_font)
    {
        _field_font = value;
        OnPropertyChanged1(::g::Uno::UX::Selector__op_Implicit1(::STRINGS[6/*"font"*/]), origin);
    }
}

// public void Setfontsize(int value, Uno.UX.IPropertyListener origin) [instance] :56
void myButton::Setfontsize(int32_t value, uObject* origin)
{
    uStackFrame __("myButton", "Setfontsize(int,Uno.UX.IPropertyListener)");

    if (value != _field_fontsize)
    {
        _field_fontsize = value;
        OnPropertyChanged1(::g::Uno::UX::Selector__op_Implicit1(::STRINGS[7/*"fontsize"*/]), origin);
    }
}
...
{
    uStackFrame __("myButton", "Settext(string,Uno.UX.IPropertyListener)");

    if (::g::Uno::String::op_Inequality(value, _field_text))
    {
        _field_text = value;
        OnPropertyChanged1(::g::Uno::UX::Selector__op_Implicit1(::STRINGS[8/*"text"*/]), origin);
    }
}
...
{
    uStackFrame __("myButton", "Settextcolor(float4,Uno.UX.IPropertyListener)");
...
{
    uStackFrame __("myButton", "set_text(string)");
    Settext(value, NULL);
}
...
{
    uStackFrame __("myButton", "set_textcolor(float4)");
