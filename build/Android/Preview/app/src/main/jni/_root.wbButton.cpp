// This file was generated based on C:/Users/SpaceJockey27/Documents/Fuse/AccountBook/build/Android/Preview/cache/ux15/wbButton.g.uno.
...
{
    wbButton::__selector0_ = ::g::Uno::UX::Selector__op_Implicit1(::STRINGS[0/*"Color"*/]);
    wbButton::__selector1_ = ::g::Uno::UX::Selector__op_Implicit1(::STRINGS[1/*"Value"*/]);
}
...
static void wbButton_build(uType* type)
{
    ...
    ::STRINGS[3] = uString::Const("TextCol");
    ...
    type->Reflection.SetFunctions(4,
        new uFunction(".ctor", NULL, (void*)wbButton__New6_fn, 0, true, type, 0),
        new uFunction("SetTextCol", NULL, (void*)wbButton__SetTextCol_fn, 0, false, uVoid_typeof(), 2, ::g::Uno::Float4_typeof(), ::g::Uno::UX::IPropertyListener_typeof()),
        new uFunction("get_TextCol", NULL, (void*)wbButton__get_TextCol_fn, 0, false, ::g::Uno::Float4_typeof(), 0),
        new uFunction("set_TextCol", NULL, (void*)wbButton__set_TextCol_fn, 0, false, uVoid_typeof(), 1, ::g::Uno::Float4_typeof()));
}
...
{
    uStackFrame __("wbButton", "InitializeUX()");
    ...
    ::g::Fuse::Reactive::Property* temp2 = ::g::Fuse::Reactive::Property::New1(temp1, ::g::AccountBook_accessor_wbButton_TextCol::Singleton());
    ...
    ::g::Fuse::Reactive::Property* temp4 = ::g::Fuse::Reactive::Property::New1(temp3, ::g::AccountBook_accessor_Fuse_Controls_ButtonBase_Text::Singleton());
    ...
    ::g::Fuse::Reactive::DataBinding* temp5 = ::g::Fuse::Reactive::DataBinding::New1(temp_Color_inst, (uObject*)temp2, 1);
    ::g::Fuse::Reactive::DataBinding* temp6 = ::g::Fuse::Reactive::DataBinding::New1(temp_Value_inst, (uObject*)temp4, 1);
    ...
    ::g::Fuse::Animations::Change* temp9 = (::g::Fuse::Animations::Change*)::g::Fuse::Animations::Change::New2(::TYPES[0/*Fuse.Animations.Change<float4>*/], wbRecCol_Color_inst);
    ::g::Fuse::Animations::Change* temp10 = (::g::Fuse::Animations::Change*)::g::Fuse::Animations::Change::New2(::TYPES[0/*Fuse.Animations.Change<float4>*/], border_Color_inst);
    ...
    temp4->SourceFileName(::STRINGS[2/*"MainView.ux"*/]);
    temp3->SourceLineNumber(17);
    temp3->SourceFileName(::STRINGS[2/*"MainView.ux"*/]);
    temp7->SourceLineNumber(18);
    temp7->SourceFileName(::STRINGS[2/*"MainView.ux"*/]);
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp7->Fills()), ::TYPES[2/*Uno.Collections.ICollection<Fuse.Drawing.Brush>*/]), wbRecCol);
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp7->Strokes()), ::TYPES[3/*Uno.Collections.ICollection<Fuse.Drawing.Stroke>*/]), border);
    ...
    temp8->SourceFileName(::STRINGS[2/*"MainView.ux"*/]);
    ...
    ::g::Fuse::Animations::Change__set_Value_fn(temp9, uCRef(::g::Uno::Float4__New2(0.6f, 0.6f, 0.6f, 1.0f)));
    temp9->Duration(0.05);
    ...
    temp11->SourceFileName(::STRINGS[2/*"MainView.ux"*/]);
    ...
    temp12->SourceLineNumber(27);
    temp12->SourceFileName(::STRINGS[2/*"MainView.ux"*/]);
...
{
    uStackFrame __("wbButton", "SetTextCol(float4,Uno.UX.IPropertyListener)");

    if (::g::Uno::Float4__op_Inequality(value, _field_TextCol))
    {
        _field_TextCol = value;
        OnPropertyChanged1(::g::Uno::UX::Selector__op_Implicit1(::STRINGS[3/*"TextCol"*/]), origin);
    }
}
...
{
    uStackFrame __("wbButton", "set_TextCol(float4)");
