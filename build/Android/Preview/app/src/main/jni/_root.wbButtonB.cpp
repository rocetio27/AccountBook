// This file was generated based on C:/Users/SpaceJockey27/Documents/Fuse/AccountBook/build/Android/Preview/cache/ux15/wbButtonB.g.uno.
...
static void wbButtonB_build(uType* type)
{
    ...
    type->Reflection.SetFunctions(4,
        new uFunction(".ctor", NULL, (void*)wbButtonB__New6_fn, 0, true, type, 0),
        new uFunction("Settextcolor", NULL, (void*)wbButtonB__Settextcolor_fn, 0, false, uVoid_typeof(), 2, ::g::Uno::Float4_typeof(), ::g::Uno::UX::IPropertyListener_typeof()),
        new uFunction("get_textcolor", NULL, (void*)wbButtonB__get_textcolor_fn, 0, false, ::g::Uno::Float4_typeof(), 0),
        new uFunction("set_textcolor", NULL, (void*)wbButtonB__set_textcolor_fn, 0, false, uVoid_typeof(), 1, ::g::Uno::Float4_typeof()));
}
...
{
    uStackFrame __("wbButtonB", "InitializeUX()");
...
{
    uStackFrame __("wbButtonB", "Settextcolor(float4,Uno.UX.IPropertyListener)");
...
{
    uStackFrame __("wbButtonB", "set_textcolor(float4)");
