...
{
    wbButton_Left::__selector0_ = ::g::Uno::UX::Selector__op_Implicit1(::STRINGS[0/*"Value"*/]);
    wbButton_Left::__selector1_ = ::g::Uno::UX::Selector__op_Implicit1(::STRINGS[1/*"Color"*/]);
}
...
static void wbButton_Left_build(uType* type)
{
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)wbButton_Left__New6_fn, 0, true, type, 0));
}
...
{
    uStackFrame __("wbButton_Left", ".ctor()");
    ctor_8();
    InitializeUX1();
}
...
{
    uStackFrame __("wbButton_Left", "InitializeUX()");
    ...
    temp5->SourceFileName(::STRINGS[2/*"MainView.ux"*/]);
    ...
    temp9->SourceFileName(::STRINGS[2/*"MainView.ux"*/]);
