// This file was generated based on C:/Users/SpaceJockey27/Documents/Fuse/AccountBook/build/Android/Preview/cache/ux15/wbTextInput.g.uno.
...
// public partial sealed class wbTextInput :2
// {
// static wbTextInput() :4
static void wbTextInput__cctor_3_fn(uType* __type)
{
}

static void wbTextInput_build(uType* type)
{
    ::STRINGS[0] = uString::Const("BudgetPage.ux");
    ...
    type->SetInterfaces(
        ...
        ::TYPES[0/*Uno.Collections.ICollection<Fuse.Node>*/], offsetof(::g::Fuse::Controls::TextInput_type, interface11),
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)wbTextInput__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextInput_type* wbTextInput_typeof()
{
    ...
    options.ObjectSize = sizeof(wbTextInput);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextInput_type);
    type = (::g::Fuse::Controls::TextInput_type*)uClassType::New("wbTextInput", options);
    type->fp_build_ = wbTextInput_build;
    type->fp_ctor_ = (void*)wbTextInput__New4_fn;
    type->fp_cctor_ = wbTextInput__cctor_3_fn;
...
// public wbTextInput() :8
void wbTextInput__ctor_8_fn(wbTextInput* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void wbTextInput__InitializeUX_fn(wbTextInput* __this)
{
    __this->InitializeUX();
}

// public wbTextInput New() :8
void wbTextInput__New4_fn(wbTextInput** __retval)
{
    *__retval = wbTextInput::New4();
}

// public wbTextInput() [instance] :8
void wbTextInput::ctor_8()
{
    uStackFrame __("wbTextInput", ".ctor()");
    ctor_7();
    InitializeUX();
}

// private void InitializeUX() [instance] :12
void wbTextInput::InitializeUX()
{
    uStackFrame __("wbTextInput", "InitializeUX()");
    ::g::Fuse::Controls::Rectangle* temp = ::g::Fuse::Controls::Rectangle::New3();
    TextAlignment(1);
    Margin(::g::Uno::Float4__New2(1.0f, 1.0f, 1.0f, 1.0f));
    SourceLineNumber(3);
    SourceFileName(::STRINGS[0/*"BudgetPage.ux"*/]);
    ...
    temp->SourceFileName(::STRINGS[0/*"BudgetPage.ux"*/]);
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(Children()), ::TYPES[0/*Uno.Collections.ICollection<Fuse.Node>*/]), temp);
}

// public wbTextInput New() [static] :8
wbTextInput* wbTextInput::New4()
{
    wbTextInput* obj1 = (wbTextInput*)uNew(wbTextInput_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
